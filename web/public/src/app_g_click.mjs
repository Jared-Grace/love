import { g_img_square_style_position_object_g_img_square_style_position_object_later } from "../../../love/public/src/g_img_square_style_position_object_g_img_square_style_position_object_later.mjs";
  ...
  if (clicked_on_player) {
    ...
    if (away) {
      ...
      let on_transition_begin =
        g_img_square_style_position_object_g_img_square_style_position_object_later(
          player,
          player_img_c,
        );
