...
export function js_auto_transforms() {
  marker("transforms");
  let transforms = [js_bang_to_not, js_await_add, js_arrow_blockify, js_if_blockify, js_arrow_to_function, js_function_id_add, js_let_add, js_declare_assign_null, js_if_else_if_combine, js_atomize_function, js_return_atomize, js_call_fill, js_dollar, js_outside_move, js_atomize];
  return transforms;
}
