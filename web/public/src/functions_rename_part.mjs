import { function_name_part_replace_curried_right_ } from "../../../love/public/src/function_name_part_replace_curried_right_2.mjs";
...
export async function functions_rename_part(from, to) {
  ...
  let r3 = function_name_part_replace_curried_right_(from, to);
