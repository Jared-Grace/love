import { js_identifier_rename_curried_right_ } from "../../../love/public/src/js_identifier_rename_curried_right_2.mjs";
...
export async function function_transform_current_identifier_rename(
  ...
  let r2 = js_identifier_rename_curried_right_(name_from, name_to);
