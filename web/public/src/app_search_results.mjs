...
import { html_border_style } from "../../../***REMOVED***/public/src/html_border_style.mjs";
...
import { html_br_2 } from "../../../***REMOVED***/public/src/html_br_2.mjs";
...
export async function app_search_results(context, div_results) {
  ...
  function each_result(vk) {
    ...
    function each_verse_number(verse_number) {
      ...
      html_border(div_verse, "0.2em", "darkgreen");
