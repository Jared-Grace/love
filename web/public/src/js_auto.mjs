...
export async function js_auto(ast) {
  let transforms = [js_arrow_blockify, js_arrow_to_function, js_function_id_add, js_let_add, js_declare_assign_null, js_atomize_function, js_call_fill, js_dollar, js_outside_move, js_atomize];
