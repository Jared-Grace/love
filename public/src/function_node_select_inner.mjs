import { js_visit_id_or_node_multiple } from "../../../love/public/src/js_visit_id_or_node_multiple.mjs";
...
export async function function_node_select_inner(
  ...
  n = list_ensure(n);
  let items_to_add = js_visit_id_or_node_multiple(ast, n);
  let r = await function_current_selects_add(items_to_add, on_previous);
  return r;
}
