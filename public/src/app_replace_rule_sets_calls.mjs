...
import { js_flo_block_body_empty_return_identifiers_curried_right } from "../../../love/public/src/js_flo_block_body_empty_return_identifiers_curried_right.mjs";
...
export async function app_replace_rule_sets_calls() {
  ...
  let r22 = js_flo_block_body_empty_return_identifiers_curried_right(names);
