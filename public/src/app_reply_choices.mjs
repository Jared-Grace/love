  ...
  let v = [
    ...
    },
    {
      ...
      response:
        ...
        emoji_book_open() +
        " all things work together for good to them that love God and are called according to the purpose of God! (Romans 8:28) However please pray that I will stop hearing demons" +
        emoji_pray(),
    },
    {
