import { function_rename_open_generic } from "../../../love/public/src/function_rename_open_generic.mjs";
...
export async function sandbox() {
  ...
  let r5 = await function_rename_open_generic(plugin_fn, f_name_old);
