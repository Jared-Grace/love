import { g_generate_upload_filter_generic } from "../../../love/public/src/g_generate_upload_filter_generic.mjs";
...
export async function g_generate_upload_filter(fn, path_get, search) {
  ...
  async function file_each(file) {
    ...
    await g_generate_upload_filter_generic(fn, path_get, file);
  }
}
