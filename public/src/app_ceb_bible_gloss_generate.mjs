...
export async function app_ceb_bible_gloss_generate() {
  ...
  let book_code = "JAS";
  const prompt_system = `You will be given a Bible passage and its context in Cebuano. For each Cebuano word, output an English gloss. Also, please output HTML that explains each word in the passage. Output: {"glosses"[{"ceb":"CEBUANO_WORD","en":"ENGLISH_GLOSS"},...],"explain":"..."} . "CEBUANO_WORD" should include any punctuation before or after a word. The original language and English are provided as a reference.`;
