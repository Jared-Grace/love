...
export async function app_ceb_bible_gloss_generate() {
  ...
  let book_code = "JAS";
  const prompt_system = `You will be given a Bible passage and its context in Cebuano. For each Cebuano word, output an English gloss. Each gloss should be contained in a JSON array like: [{"ceb":"CEBUANO_WORD","en":"ENGLISH_GLOSS"},...] . The original language and English are provided as a reference.`;
