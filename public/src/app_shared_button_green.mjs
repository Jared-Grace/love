import { app_karate_button_screen_green_style_assign } from "../../../karate_code/public/src/app_karate_button_screen_green_style_assign.mjs";
...
export function app_shared_button_green(div, text, lambda) {
  ...
  app_karate_button_screen_green_style_assign(component);
  return component;
}
