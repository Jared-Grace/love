import { global_function_initialize_lambda_info_async } from "../../../love/public/src/global_function_initialize_lambda_info_async.mjs";
...
export async function file_read_cached_initialize(f_path) {
  ...
  let value = await global_function_initialize_lambda_info_async(fn, lambda2);
