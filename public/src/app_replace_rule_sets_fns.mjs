import { app_replace_rule_set_expresions_additive } from "../../../love/public/src/app_replace_rule_set_expresions_additive.mjs";
...
export function app_replace_rule_sets_fns() {
  let r2 = [
    ...
    app_replace_rule_set_expresions_additive,
  ];
  return r2;
}
