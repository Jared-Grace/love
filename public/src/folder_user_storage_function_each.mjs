import { firebase_storage_download_path } from "../../../love/public/src/firebase_storage_download_path.mjs";
...
export async function folder_user_storage_function_each(fn, file_each) {
  let path = firebase_storage_download_path("\\storage\\function\\" + fn.name);
