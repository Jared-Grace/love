...
export function g_arc_prompt(
  ...
  let lines = [
    ...
    "",
    "THE TURNS",
    "Here is a turn: the player chooses an opener, the person answers it, and the player answers them with a passage chosen from a list.",
    ...
    "",
    "Ask yourself before writing anything: Ideally, what passages should I choose for equal usage? Then ask: what overall arc flow and story for this person is needed to choose these passages?",
    "Keep that working to yourself. What it settles is the summary you write below, and the turns are that same arc lived out in detail.",
    "",
