...
export function g_arc_prompt(chapter_code, verses_text, turn_target, profile) {
  ...
  let lines = [
    ...
    "",
    "Ask: Ideally, what passages should I choose for equal usage? Then ask: what overall arc flow is needed to choose these passages? ",
    "",
    ...
    "  summary - one sentence: who they are and their trouble",
    "",
