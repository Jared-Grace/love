...
export function g_arc_prompt(
  ...
  let lines = [
    ...
    "Days pass in between, and never the same number of them. The next conversation may be the very next day, or many days later. You are not told which, and neither is the player.",
    "So open a later conversation as somebody picking the thread back up after a while, and never as somebody carrying on the same morning.",
    "",
    "What you write is a SUMMARY of this life, never a transcript of it. John 21 verse 25 says the world could not hold the books if everything Jesus did were written down, and the Gospels are short. So write the same way.",
