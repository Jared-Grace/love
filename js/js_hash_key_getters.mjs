...
export function js_hash_key_getters(ast) {
  "Every function this file calls to get the name of a field of the address of a page - counting every address it touches, the links it builds to hand to another page included.";
  ...
  "The widest set of addresses on purpose, because freezing is what this reading feeds and a word saved into a link is lost the same way whichever page the link goes on to open. The narrower reading, over the addresses a page reads back itself, is next door.";
