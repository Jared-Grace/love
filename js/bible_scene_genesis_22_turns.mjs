...
export function bible_scene_genesis_22_turns() {
  ...
  ("★ THE VANTAGE IS ABRAHAM, AND THAT IS NOT A FREE CHOICE. an angel is present for two of this chapter's four events, so an angel vantage looked available — but the figure is THE ANGEL OF THE LORD, who stops the knife and then swears BY HIMSELF (22:16) and says Isaac was not withheld FROM ME (22:12). whoever that is, the player may not be him. so the rule 'play the angel where an angel is present' is too coarse: a created messenger is playable, the angel of the LORD is not, and telling them apart takes reading the passage rather than consulting a flag. nobody does wrong anywhere in 22:1-19, which is what makes the human vantage permitted here at all");
