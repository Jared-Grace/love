...
export async function app_g_hero_taller(hero) {
  ...
  ("One more evil person stopped, and the player stands a little taller for it - she rises");
  ("out of the pavement with a swell of white light and stays at her new height.");
