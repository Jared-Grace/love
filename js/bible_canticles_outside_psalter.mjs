...
export function bible_canticles_outside_psalter() {
  ...
  "Two hundred and forty-eight verses, of which Lamentations is a hundred and fifty-four, against the three hundred and twenty-five the text itself calls sung and the Psalter's two thousand four hundred and sixty-one.";
