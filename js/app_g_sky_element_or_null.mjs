...
export function app_g_sky_element_or_null() {
  ...
  "there is one of these at a time and it is not passed around - the element is made by a map refresh and stashed globally by app_g_sky_set, so anything that wants to repaint or drift the sky has to come and ask for it rather than being handed it";
