...
export async function bible_audio_verses_manifest_chapter_write(
  ...
  "★ THE FOLDER OF RECORDINGS IS NOT ALWAYS NAMED FOR A TRANSLATION, SO ITS NAME IS RESOLVED BEFORE THE CHAPTER IS ASKED FOR. A run recorded at full speed sits in a folder called engwebu_full_speed, and asking for a translation by that name is refused - which reported two hundred and thirteen chapters as unjudgeable while their words were on the disk the whole time.";
