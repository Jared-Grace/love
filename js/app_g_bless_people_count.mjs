...
export function app_g_bless_people_count() {
  ...
  "That also makes the crowd follow the ground. Build a third block and a block's worth of";
  "people arrive to live on it, with no second number to remember to change.";
  "It is still the size a walkable street can carry, and that limit does NOT sit here. A";
  "person blocks the tile they stand on, so what matters is how many stand on ONE pavement,";
  "and that is a block's worth however many blocks there are - which means this number can";
  "never be the crowding one, and turning it down would only build fewer streets with the";
  "same jam on each. The crowding is set where a block's worth is decided, by how many";
  "households a building holds.";
