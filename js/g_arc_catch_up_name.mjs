...
export function g_arc_catch_up_name() {
  ...
  "The prompt SPEAKS this name as well as defining it: it says when the catch-up line is said and it says that line cannot answer the opener the player has not chosen yet. Those are ordinary sentences with the word sitting in them, so a rename that fixed the definition would leave them naming a field that no longer exists - and nothing would go red, because a prompt is prose.";
