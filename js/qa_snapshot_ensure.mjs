...
export async function qa_snapshot_ensure(commit) {
  ...
  "The siblings are frozen beside it, because a name in another repo is looked up by stepping out of this folder and back down by name, and the sweeps that ask after every function walk the neighbours as well as this repo";
