...
export async function lyric_video_document_pictures_model_bench_negative(
  ...
  "$plain model";
  "$plain size";
  "Draws every scene an authored document asks for on one named model at one named size, steering the drawing away from lettering, and puts the results in a folder of their own so the same model's plain run stays beside them to be compared.";
  ...
  "Everything else about the run - which scenes, where they land, what counts as already drawn - is the run its plain twin makes, and is written where that is said. This is the asking, the size, and the ending on the folder, and nothing more.";
