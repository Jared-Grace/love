...
export function app_g_reveal_scripture(correct) {
  ...
  let b = property_get(correct, "verse_span");
  html_style_set(b, "color", "#8a6508");
  let b2 = property_get(correct, "verse_span");
  html_style_set(b2, "text-shadow", "0 0 0.15em rgba(0, 0, 0, 0.4)");
  let b3 = property_get(correct, "reference_span");
  html_style_set(b3, "color", "forestgreen");
