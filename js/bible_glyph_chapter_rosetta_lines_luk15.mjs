export function bible_glyph_chapter_rosetta_lines_luk15() {
  ...
  let chapter = {
    ...
    verses: [
      ...
      {
        verse_number: 3,
        original: "Εἶπεν δὲ πρὸς αὐτοὺς τὴν παραβολὴν ταύτην λέγων",
        english: "Then Jesus told them this parable",
      },
      {
        verse_number: 4,
        original:
      ...
      {
        verse_number: 5,
        original: "καὶ εὑρὼν ἐπιτίθησιν ἐπὶ τοὺς ὤμους αὐτοῦ χαίρων",
        english: "And when he finds it he joyfully puts it on his shoulders",
      },
      {
        verse_number: 6,
        original:
      ...
      {
        verse_number: 11,
        original: "Εἶπεν δέ Ἄνθρωπός τις εἶχεν δύο υἱούς",
        english: "Then Jesus said There was a man who had two sons",
      },
      {
        verse_number: 12,
        original:
      ...
      },
      {
        ...
        english: "So he called one of the servants and asked what was going on",
      },
      {
        verse_number: 27,
        original:
