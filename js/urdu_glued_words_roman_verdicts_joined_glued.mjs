...
import { urdu_glued_words_roman_verdicts_joined_glued_phrase } from "./urdu_glued_words_roman_verdicts_joined_glued_phrase.mjs";
...
export async function urdu_glued_words_roman_verdicts_joined_glued() {
  ...
  let r2 = await urdu_glued_words_roman_verdicts_joined_glued_phrase(control);
