...
export function app_code_lesson_expression_choose_order_three_above(
  root,
  context,
) {
  ...
  ("No heading is asked for above the line. A heading is for a lesson walking two lines that has to say how the second one differs from the first, and this lesson walks one.");
