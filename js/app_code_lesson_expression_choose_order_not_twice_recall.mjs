...
export function app_code_lesson_expression_choose_order_not_twice_recall(root, context) {
  ...
  app_code_remember_from_lesson(recall_card, context, app_code_lesson_expression_not, [
    "",
    symbol,
