...
export function app_code_lesson_expression_arithmetic_equality() {
  ...
  return lesson;
  function above(root) {
    let r = app_code_lesson_expression_arithmetic_equality_above(root);
    return r;
  }
}
