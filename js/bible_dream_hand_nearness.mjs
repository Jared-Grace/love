...
export function bible_dream_hand_nearness(gap_squared, far) {
  ...
  "★ THE DISTANCE IT IS MEASURED AGAINST IS HANDED IN AND IS NOT THE CORRIDOR. It used to be the corridor, and the corridor is two and a half units, so the whole visible change was spent before a hand had wandered as far as a fingertip is wide and everything beyond it sat on the floor looking identical. What decides how faint a mark is has to be spread over the distances a hand really strays, which is a different number and a much larger one.";
