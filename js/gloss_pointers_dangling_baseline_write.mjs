...
import { gloss_pointers_dangling_baseline_growth_assert } from "./gloss_pointers_dangling_baseline_growth_assert.mjs";
import { gloss_pointers_dangling_baseline_path } from "./gloss_pointers_dangling_baseline_path.mjs";
import { baseline_known_write } from "./baseline_known_write.mjs";
export async function gloss_pointers_dangling_baseline_write() {
  "Rewrite the record of how often each gloss store sends the reader back to a word met earlier and finds nothing there, from what the stores hold right now.";
  ...
  await gloss_pointers_dangling_baseline_growth_assert(counts);
