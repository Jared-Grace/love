export function song_image_couplet_glosses() {
  ...
  let glosses = {
    ...
    19: {
      kept: 2,
      lyric_ref: "Matthew 27:59-60, John 19:39-40, Luke 23:56",
      lyric_explain:
        "HE wrapped it in a clean linen cloth and laid it in HIS own new tomb. John gives the myrrh and aloes by weight and says it was the manner of the Jews to bury.",
      symbol_explain:
    ...
    21: {
      ...
      symbol_explain:
        "Described. The rolling stone is in all four accounts. Covering has to be drawn as where the black shows past the stone's edges, because this look forbids perspective and nothing can stand in front of anything.",
    },
    22: {
      kept: 3,
      lyric_ref: "Matthew 27:65-66",
      lyric_explain:
        "Ye have a watch: go your way, make it as sure as ye can. Pilate grants the guard, and the couplet follows Matthew exactly, including that the securing was the accusers' idea and not his.",
      symbol_explain:
    ...
    28: {
      ...
      symbol_explain:
        "Described. HE shall send HIS angels with a great sound of a trumpet, and the trumpet shall sound in 1 Corinthians 15:52. It is drawn straight and plain because a valved instrument is a modern object and its detail dies on a phone.",
    },
    29: {
      kept: 1,
      lyric_ref: "2 Corinthians 5:10, Romans 2:6, Revelation 22:12",
      lyric_explain:
        "We must all appear before the judgment seat of CHRIST, that every one may receive the things done in HIS body. My reward is with me, to give every man according as his work shall be.",
      symbol_explain:
