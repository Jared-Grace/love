...
export function app_code_lesson_expression_choose_order_same_strength_questions() {
  ...
  ("No line carries both a strength that jumps and one that waits, so no line can be answered by knowing which operator is the stronger. What is left to read is position, and position is the whole of the lesson.");
