...
export function js_selects_call_get(selects) {
  ...
  ("Every verb that changes one call named by an address starts here, and each of");
  ("them wrote the same two steps: insist the address found exactly one thing,");
  ("then take the call from it whether the address stopped at the call or at the");
  ("line holding it. A verb handed the call node already is a different thing and");
  ("has no use for this.");
