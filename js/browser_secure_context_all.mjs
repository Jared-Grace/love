...
export async function browser_secure_context_all() {
  "Every function in this repo that reaches for something a browser hands out only over https, as one line each saying which function and which thing. Read-only.";
  ...
  for (let entry of entries) {
    ...
    let members = js_secure_context_members(tree);
