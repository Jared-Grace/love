...
export function app_code_lesson_expression_choose_order_not_twice_intro(
  ...
  "Nothing is said about parentheses, because there are none and none are needed. A learner who has just come from lines that had to be parenthesised would take a sentence saying so as a fourth thing to hold, and there is nothing there to hold.";
