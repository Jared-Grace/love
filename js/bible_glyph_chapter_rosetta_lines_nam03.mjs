export function bible_glyph_chapter_rosetta_lines_nam03() {
  ...
  let chapter = {
    ...
    verses: [
      ...
      },
      {
        verse_number: 3,
        original:
          "פָּרָ֣שׁ מַעֲלֶ֗ה וְלַ֤הַב חֶ֙רֶב֙ וּבְרַ֣ק חֲנִ֔ית וְרֹ֥ב חָלָ֖ל וְכֹ֣בֶד פָּ֑גֶר וְאֵ֥ין קֵ֙צֶה֙ לַגְּוִיָּ֔ה יִכְשְׁלוּ בִּגְוִיָּתָֽם׃",
        english:
