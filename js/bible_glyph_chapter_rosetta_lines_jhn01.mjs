export function bible_glyph_chapter_rosetta_lines_jhn01() {
  ...
  let chapter = {
    ...
    verses: [
      ...
      {
        verse_number: 34,
        original: "κἀγὼ ἑώρακα καὶ μεμαρτύρηκα ὅτι οὗτός ἐστιν ὁ Υἱὸς τοῦ Θεοῦ",
        english: "I have seen and testified that this is the Son of God",
      },
      {
        verse_number: 35,
        original:
      ...
      },
      {
        ...
        english: "When he saw Jesus walking by he said Look the Lamb of God",
      },
      {
        verse_number: 37,
        original:
