...
export function bible_end_sentence_ahead(ended, ahead_after) {
  "How many verses on from this one the sentence it sits in finishes, given whether this verse finished one and that same answer for the verse after it.";
  ...
  "It is handed the answer rather than the verse because who is being read decides that answer and nothing else here does. One bible answers from its own marks; a reader of three is answered only when all three have finished, which is a different question with the same shape. Both come here for the counting.";
