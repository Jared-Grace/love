...
export async function word_pictures_drawn_known_write() {
  "Count what is actually in the word picture folders and write word_pictures_drawn_known from it, so the table the review screen reads says what the disk says.";
