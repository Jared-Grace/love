...
export async function gloss_write_files_verse_keys_generic(
  chapter_code,
  fn,
  opening,
) {
  "The verses of every passage of one chapter that has one named kind of text waiting to be written into it, read off the names of the files the text was handed over in.";
  "$plain chapter_code";
  ...
  "Which passages have text waiting is a fact about the folder, so it is read off the folder rather than typed out again beside it. A chapter is mended over many sittings and a list written by hand goes stale between two of them - quietly, because a passage left off a list looks exactly like a passage that needed nothing.";
