...
export function gloss_store_words_read(fn) {
  ...
  "The Cebuano store is read with the dash kept, because Cebuano spells the catch in the throat with one, inside the word - panan-aw, nag-ingon, kabubut-on. Every other store keeps the reading it is given today, which cuts there, and that has since been measured rather than assumed. Asked on 2026-09-07, the original-language store held no explained word with a dash in it at all, and all twelve in the English store were ordinary English compounds - forty-six, mother-in-law, demon-possessed, well-pleasing - where cutting is exactly what English wants. So this is a chooser and not a repair: adopting it changes one store's answer and no other's.";
