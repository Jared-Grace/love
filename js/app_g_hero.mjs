...
import { app_g_bless_container_new } from "./app_g_bless_container_new.mjs";
...
export async function app_g_hero(context) {
  ...
  let container = app_g_bless_container_new(context);
  let cover = app_g_bless_cover();
  app_g_hero_play(container);
  await app_g_bless_cover_lift(container, cover);
}
