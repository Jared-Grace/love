...
export function ebible_readaloud_lines_offered_unchecked(recorded) {
  "Which of the bibles a reader can actually choose have chapters that were never really checked, whatever the record's count of bibles says.";
  "One unread chapter is enough to name a bible here, and the count beside the name is what tells a bible one chapter short from a bible with nothing at all. Nearly all of it being readable is not the same as all of it: the unread chapter is a chapter of the Bible this app shows to nobody, and it goes on being that whether it stands alone or among a thousand that work.";
  "So a name in this list does not mean nobody looked at that bible. It used to be described that way, back when every bible in it was one whose reading-aloud text had not arrived at all, and the description outlived the case - it sent somebody hunting a total failure in a bible that was a single chapter short of complete.";
