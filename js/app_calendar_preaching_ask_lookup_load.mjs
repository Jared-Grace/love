...
import { property_exists_not_if_async } from "./property_exists_not_if_async.mjs";
import { app_calendar_facebook_name } from "./app_calendar_facebook_name.mjs";
import { list_single } from "./list_single.mjs";
import { playwright_sleep_goto } from "./playwright_sleep_goto.mjs";
...
import { playwright_session_load } from "./playwright_session_load.mjs";
import { playwright_session_save_facebook_name } from "./playwright_session_save_facebook_name.mjs";
...
export async function app_calendar_preaching_ask_lookup_load() {
  ...
  let r = await playwright_session_load(session_name);
  ...
  async function lambda(url_id) {
    ...
    async function lambda2() {
      let url_goto1 = text_combine("https://www.facebook.com/", url_id);
    ...
    async function lambda4() {
      let url_goto = text_combine("https://www.m.me/", url_id);
