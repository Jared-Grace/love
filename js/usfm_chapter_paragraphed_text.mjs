...
import { usfm_lines_chapter_taken } from "./usfm_lines_chapter_taken.mjs";
import { usfm_lines_laid_out } from "./usfm_lines_laid_out.mjs";
import { list_join_newline } from "./list_join_newline.mjs";
import { text_trim } from "./text_trim.mjs";
export function usfm_chapter_paragraphed_text(
  usfm,
  chapter_number,
  verse_numbers_shown,
) {
  ...
  let chapter_lines = usfm_lines_chapter_taken(lines, chapter_number);
  let laid_out = usfm_lines_laid_out(chapter_lines, verse_numbers_shown);
