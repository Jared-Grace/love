...
export function data_loose_rooms() {
  ...
  let rooms = [
    [fn_name("commands_only_path"), "settings"],
    [fn_name("data_aliases_path"), "settings"],
    [fn_name("literals_frozen_path"), "frozen"],
    [fn_name("storage_local_key_names_path"), "frozen"],
    [fn_name("storage_local_key_words_path"), "frozen"],
  ];
  return rooms;
}
