...
export async function ebible_verses_readaloud_source(
  ...
  ("It stands apart from the repaired reading because a reading that looks for what is wrong with a file cannot be handed that file with the wrong things already put right in it. The detector that finds the Urdu bible's welded words was asked through the repair, and of the words it then offered, not one was a word it had itself been taught to mend: those were gone from what it was shown. The gate still catches damage nobody has ruled on, but nothing anywhere can any longer say how much of the known damage is still in front of a reader. A remedy that hides the fault from the instrument leaves the fault unmeasurable.");
