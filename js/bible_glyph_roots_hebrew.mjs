export function bible_glyph_roots_hebrew() {
  ...
  "THE TWENTY THIRD PSALM WAS ASKED FOR AND IT BOUGHT ONE PICTURE OUT OF FOUR, which is the clearest case yet of a measurement earning its keep. The shepherd, the sheep, the rod and the staff were named together as the vocabulary that psalm is made of, and taken one at a time they come apart completely: tson measures two hundred and seventy two and clean and is bought; raah measures a hundred and seventy three and clean and needs no picture, because a human beside a sheep already says it; shebet and mishenah are both refused, and for two different reasons neither of which is about a picture.";
  "SHEBET IS MATTEH AGAIN AND THE COUNT IS WORSE. The interlinear glosses it the tribes, the tribe, of the tribes seventy one times against the rod and the scepter nine, because the stick a chief holds and the tribe he holds it over are one word in Hebrew - which is the exact fault matteh was refused for on the twentieth. A rod drawn there would be a wrong mark on four occurrences in five, and it would be wrong in Numbers, where the word is doing nothing but counting Israel. The famous verse loses its rod so that the census does not gain one.";
  "MISHENAH IS REFUSED BY SIZE AND NOT BY MEANING, which is the rarer of the two refusals here. Every one of its wordings is a staff or a support and there is no second sense hiding under it, so it would have been an honest mark; there are twelve occurrences in the whole Old Testament. A picture costs an artwork decision, a gate row and a line in a vocabulary every later reader carries, and twelve occurrences does not pay for that. So the fourth verse of the psalm draws neither of the two things it names, and the blank is the honest report of a word this table cannot say.";
  "THE SHEPHERD IS THE SECOND GROUP IN THIS TABLE AND THE FIRST ONE PROPOSED FROM OUTSIDE IT. What was offered was the human, the heart and the sheep, and the heart is what had to come off. The red heart is already seated on ahava, so a reader who has learned it reads the group as a human who loves sheep - and raah says pastures, feeds, tends, grazes, and says nothing whatever about affection. The two chapters where the word matters most are the ones that break: the thirty fourth of Ezekiel is the shepherd chapter and it is a rebuke, so woe to the shepherds of Israel would draw as woe to those who love the sheep, and the hireling of the tenth of John fails by not caring while still being called what he is called.";
  "SO IT IS THE HUMAN AND THE SHEEP AND NOTHING ELSE, and it passes the test the blessing set. Each half is honest standing alone - a human is a human and a sheep is a sheep - so a reader who has met either elsewhere reads this correctly on sight, and a reader who has met neither learns two words from one shepherd. A third mark would not have added a picture, it would have added a claim, and the claim was one the word does not make. A group multiplies what is honest; it also multiplies what is not.";
  "AND A GROUP WAS PREFERRED OVER A COMMISSION HERE, WHICH IS THE OPPOSITE OF THE ALTAR AND THE PRIEST. Those two were drawn as English words because composing them said something false, and a word drawn as English belongs to the drawn text alone and can never be sent as a message. The shepherd composes honestly, so it costs no artwork, no file and no waiting, and it says shepherd in the plain emoji text the same day. The commission is what you take when the group fails the test, never what you take first.";
  "THE ANOINTING WAS BOUGHT FOR NOTHING AND IT WAS THE NEW TESTAMENT THAT FOUND IT. Writing the second of first John showed christos drawn with the oil in one verse and chrisma standing in bare English two verses later, which breaks the one link that chapter is built on. The Greek fix seats chrisma and chrio on the oil they came from; asking the same question here found mashach at sixty eight and mashiach at thirty nine, both of them the word christos translates, and both blank. A hundred and seven occurrences seated with a picture that already existed, because somebody read a chapter instead of a list.";
  "AND SHEMEN WAS REFUSED IN THE SAME BREATH, which is the point of writing this down. The obvious next move is the oil itself - a hundred and ninety three occurrences, glossed oil or olive oil in nearly every wording, sitting right there. But this mark is not oil. It is the anointed one, seated on christos, and hanging it on shemen would draw the Messiah over every jar of cooking oil in Leviticus and every lamp in the tent of meeting. It is the koinonia and berith refusal again: the near word is the dangerous one, because nothing goes red when a picture quietly starts saying something else.";
  "GOD'S JEALOUSY WAS SPLIT OFF FROM HUMAN ENVY ON 2026-08-25, AND A MEASUREMENT FOUND IT RATHER THAN A CHAPTER. Every seat in this table was read against every wording the interlinear gives its number, weakest first, and the burning heart came back split down the middle in both testaments at once - jealous nine, envy six, provoked four, envied four, zealous four. Holy jealousy and sinful envy are one root in Hebrew and one root in Greek, and one picture was drawing both.";
  "AND THE ERROR IT RISKS IS A CLAIM ABOUT GOD, which is why it is written here rather than left in a survey. The burning heart stands in exactly one authored verse, the fifth of the twentieth of Exodus, where God names himself jealous - so a reader meets the picture from God first, and would then meet the same picture over Rachel and over Joseph's brothers and learn that God envies. Nothing anywhere would go red. The mark would simply teach it.";
  "THE OBVIOUS REPAIR WAS TRIED AND THE GATES REFUSED IT, and the refusal was right. Hebrew spends three numbers on this root and one of them, 7067, is an adjective said of God and of nobody else, so it alone could take a mark of its own without anybody deciding anything about any particular verse. It was seated on the burning heart with the crown - the crown already says Lord - and the spellable-groups gate refused it in both testaments at once: the crown is seated on adon and on kurios, so an ordinary burning zeal standing before an ordinary Lord spells that group by accident, and a reader who reads the gap as narrow gets a word nobody wrote.";
  "AND NO OTHER PAIR WAS AVAILABLE, WHICH IS THE REAL STATE OF THE VOCABULARY. Two pictures of ninety six are seated on nothing, the dove and the equals sign, and both are held back on purpose - the dove for the Spirit's own verse and the equals sign as the record of a claim this Bible refused to make. So there is no honest second half for any group at all until a new picture is bought, and buying one for a word that occurs six times in the whole Old Testament is the wrong trade against a vocabulary this tight.";
  "AND A GROUP WAS THE WRONG SHAPE OF ANSWER ALL ALONG, which is worth saying plainly because the argument above spends four paragraphs inside it. A group is ONE word drawn with TWO marks, and it can be spelled by accident because two marks standing side by side are what ordinary writing already looks like. Splitting a sense off a word does not want that at all - it wants ONE new mark, seated alone on 7067, and a single mark cannot be spelled by accident by anything. So the empty pool and the spellable-groups gate were both answering a question this repair never had to ask, and the next person here should reach for a picture before they reach for a pair.";
  "THE FREQUENCY IS WHAT ACTUALLY REFUSES IT, AND IT REFUSES CLEANLY. 7067 is SIX occurrences in the whole Old Testament, counted rather than guessed - against a bar that already turned down the staff of the twenty third psalm at twelve for being too rare to pay for a picture, a gate row and a line of vocabulary. Six is half of twelve. That is the whole of the refusal, it would have been reached in one reading, and the four paragraphs above are what it costs to argue about spelling before measuring.";
  "SO THE REPAIR IS IN THE AUTHORING AND NOT IN THE TABLE. The three numbers keep one mark, which is what the language does, and the rule is that a human envy is written in plain English rather than drawn. A seated word left in English costs nothing and is already ordinary here - it is what every undrawn word does - so Rachel envying her sister simply reads, and the burning heart is met only where the zeal is God's or is a man's zeal for God. That rule lives in this paragraph because the chapter author is the only person who can apply it, and the moment they are choosing marks is the only moment it can be applied.";
  ...
  "AND THE SHARING HAD BEEN COSTING PICTURES THE WHOLE TIME, in two different ways that are easy to run together. A hundred and forty one marks stood in a line that held both words at once; those were drawn, but only their order said which was which, so the page carried a distinction it could not show. The other cost is the larger one and it leaves no mark at all: a hundred and sixty four times, spread over a hundred and thirteen written chapters, the covenant name is still plain English letters, written out because whoever authored the line could not draw it without drawing the other word too. The fourteenth verse of the fourth of Ruth is the one the chapters themselves complain about - the neighbours bless God for giving Naomi a redeemer and pray the child will be famous, and both words sit there in letters.";
