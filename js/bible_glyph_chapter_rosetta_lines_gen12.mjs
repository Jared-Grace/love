export function bible_glyph_chapter_rosetta_lines_gen12() {
  ...
  let chapter = {
    ...
    verses: [
      ...
      {
        verse_number: 9,
        original: "וַיִּסַּ֣ע אַבְרָ֔ם הָל֥וֹךְ וְנָס֖וֹעַ הַנֶּֽגְבָּה׃פ",
        english: "And Abram journeyed on toward the Negev",
      },
      {
        verse_number: 10,
        original:
