export function bible_glyph_chapter_rosetta_lines_lev26() {
  ...
  let chapter = {
    ...
    verses: [
      ...
      },
      {
        ...
        english: "If you follow My statutes and carefully keep My commandments",
      },
      {
        verse_number: 4,
        original:
      ...
      },
      {
        ...
        english: "You will eat the flesh of your own sons and daughters",
      },
      {
        verse_number: 30,
        original:
