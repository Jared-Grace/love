...
export function app_code_lesson_expression_choose_order_parentheses_title_name_id() {
  ...
  ("The shape cannot tell this lesson from its twin, which draws the very same lines, so the one word Solve does it: the twin wears the shape alone. That is how every pressing lesson in this course stands beside the lesson asking the same line all at once.");
