...
export async function ebible_readaloud_lines_differ(bible_folder) {
  ...
  async function lambda(chapter_code) {
    async function lambda2() {
      let markers = await ebible_chapter_verse_markers(
        bible_folder,
        chapter_code,
      );
