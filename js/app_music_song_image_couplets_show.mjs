...
export async function app_music_song_image_couplets_show(parent, song) {
  ...
  "THE SCRIPTURE IS SET TRAVELLING BEFORE THE FIRST LINE IS DRAWN, and waited for at the end. Which passages the song rests on was settled long before anybody opened the page, so there was never a reason for the ask to wait behind the drawing of thirty-six pictures and ninety cards. Nothing waits for it here either - the drawing runs straight on and the words reach the reader exactly as soon as they did before. The saving is small and is meant to be: what it buys is that the ask stays at the front however much this loop grows.";
