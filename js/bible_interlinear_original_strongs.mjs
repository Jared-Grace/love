...
export async function bible_interlinear_original_strongs() {
  ...
  "One spelling answering to two numbers keeps the last it was given. That happens where one shape belongs to two entries, and no reading of the spelling alone could tell them apart anyway - the alternative is not a better answer but a longer way of writing the same guess.";
