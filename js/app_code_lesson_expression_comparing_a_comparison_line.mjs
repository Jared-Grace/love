...
export function app_code_lesson_expression_comparing_a_comparison_line(
  ...
  "the whole line as the learner reads it - 3 === 5 === false - joined from its three parts in the one place, because the lesson shows it more than once: at the top as the line it sets out to solve, and again at the foot of every walkthrough, where it is the thing the answer is an answer to";
