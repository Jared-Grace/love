...
export async function bible_interlinear_caches_clear() {
  ...
  "the tables.";
  "To run whenever the base-text filter changes. Both of these are copies of a reading that";
  ...
  "Both go together on purpose. They are two copies of the same underlying decision, so";
  "clearing one and leaving the other is a repo that disagrees with itself about what the";
  "text of scripture is, which is worse than either answer on its own.";
  let names = [];
