...
export async function permission_grant_refusals_names(names) {
  "Every reason each of a list of dispatcher functions must not be handed an automatic allow rule - one answer per name, under the name it belongs to, and an empty list against a name is the clean answer.";
