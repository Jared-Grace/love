...
export function http_local_file_name(url) {
  "local mirror path for a cached URL: the SAME relative path Firebase uses (http/<name>), under the mirror root — so http_local's cache is part of the one Firebase mirror, not a separate flat dump under function/http_local/";
