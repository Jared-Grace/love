...
export function app_code_lesson_expression_choose_order_not_twice_rewritten_chip(
  ...
  "Left ! blue, right ! amber, brackets red, and left is first. The sentences are read in that order and the two ! are met in that order, so the pairing is the order they are already being read in.";
