...
export function song_image_review_row(parent, asked) {
  ...
  "the picture is drawn full width rather than in the audit page's narrow column, because the two pages ask different questions of it. The audit asks whether the picture and the words say the same thing, which is answered from a thumbnail; this one asks whether the picture is any good, which is not.";
