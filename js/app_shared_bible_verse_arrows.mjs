...
export function app_shared_bible_verse_arrows(
  ...
  async function lambda8() {
    await html_scroll_top_now(content);
  }
  function middle(row) {
    let text_up = emoji_arrow_up();
    app_shared_button(row, text_up, lambda8);
  }
