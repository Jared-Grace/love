...
export function permission_grant_names() {
  ...
  let spelled756 = fn_name("functions_identifiers_renamed_without_naming_check_gate_run");
  let spelled757 = fn_name("js_identifiers_renamed_without_naming_check_cases_gate_run");
  ...
  let spelled795 = fn_name("js_function_declaration_unused_remove_cases_gate_run");
  ...
  let spelled881 = fn_name("functions_rename_if_starts_ends_with_prefix_change");
  ...
  let spelled923 = fn_name("app_code_lesson_expression_equal_number_string_true_false");
  let spelled924 = fn_name("app_code_lesson_expression_equal_number_string_true_false_title_name_id");
  ...
  let spelled1020 = fn_name("app_original_bible_gloss_generate_upload_namespace");
  ...
  let spelled1087 = fn_name("app_code_lesson_expression_which_part_first_gate_run");
  ...
  let spelled1128 = fn_name("app_replace_abbreviations_unspelled_baseline_write");
  ...
  let spelled1159 = fn_name("app_code_lesson_expression_parentheses_both_sides_title_name_id");
  ...
  let spelled1167 = fn_name("app_shared_bible_hash_field_reference_cases_gate_run");
  ...
  let spelled1209 = fn_name("app_code_lesson_quiz_token_select_meaning_variations_cases_gate_run");
  let spelled1210 = fn_name("app_ceb_bible_gloss_chapters_absent");
  let spelled1211 = fn_name("app_ceb_bible_gloss_generate_chapter_bible_folders");
  ...
  let spelled1397 = fn_name("app_original_bible_gloss_parsings_exceeding_chapters");
  ...
  let spelled1422 = fn_name("app_shared_gloss_bible_generate_generic_prompt_system");
  ...
  let spelled1461 = fn_name("app_original_bible_gloss_explains_write_files_spent_delete");
  ...
  let spelled1516 = fn_name("app_en_learn_bible_gloss_urdu_misaligned_gate_run");
  ...
  let spelled1525 = fn_name("app_original_bible_gloss_punctuation_entries_repair");
  let spelled1526 = fn_name("app_original_bible_gloss_words_distinct");
  let spelled1527 = fn_name("app_ceb_bible_gloss_chapter_verse_recurrence_claims");
  ...
  let spelled1538 = fn_name("app_ceb_bible_gloss_chapter_verse_position_claims");
  let spelled1539 = fn_name("app_ceb_bible_gloss_chapters_verse_position_claims");
  ...
  let spelled1548 = fn_name("app_en_learn_bible_gloss_urdu_punctuation_entries_repair");
  let spelled1549 = fn_name("gloss_glosses_write_file_path");
  let spelled1550 = fn_name("app_en_learn_bible_gloss_urdu_chapter_upload_stored");
  ...
  let spelled1586 = fn_name("app_ceb_bible_gloss_roots_shallower_baseline_write");
  let spelled1587 = fn_name("folder_root_move_bare_named");
  let spelled1588 = fn_name("app_shared_text_reader_untranslated_gate_run");
  let spelled1589 = fn_name("app_original_bible_gloss_glosses_write_files_spent_delete");
  ...
  let spelled1608 = fn_name("app_ceb_bible_gloss_affix_letters_apart_baseline_write");
  ...
  let spelled1633 = fn_name("app_original_bible_gloss_glosses_write_chapter_file");
  ...
  let spelled1639 = fn_name("app_original_bible_gloss_placeholders_chapter_entries");
  ...
  let spelled1678 = fn_name("firebase_storage_download_json_decompress_if_compressed");
  ...
  let spelled1683 = fn_name("ebible_readaloud_lines_offered_to_fetch_baseline_write");
  ...
  let spelled1726 = fn_name("ebible_languages_derivatives_forbidden_bible_folders");
  ...
  let spelled1732 = fn_name("ebible_languages_licences_commercial_not_bible_folders");
  ...
  let spelled1781 = fn_name("ebible_bible_folder_storage_chapter_codes_first_page");
  ...
  let spelled1836 = fn_name("js_function_declaration_to_block_body_cases_gate_run");
  ...
  let spelled1880 = fn_name("bible_glyph_chapters_rosetta_lines_notation_gate_run");
  ...
  let spelled1930 = fn_name("app_replace_rule_sets_fns_rules_used_rows_rewrite");
  ...
  let spelled1946 = fn_name("bible_glyph_chapters_rosetta_lines_marks_gate_run");
  ...
  let spelled1956 = fn_name("psalms_videos_verse_mislabelled_playlists_order_moves");
  ...
  let spelled1960 = fn_name("psalms_videos_verse_mislabelled_descriptions_write");
  ...
  let spelled2134 = fn_name("bible_versions_english_choices_words_none_everywhere_gate_run");
  ...
  let spelled2166 = fn_name("bible_glyph_chapters_verse_marks_underdrawn_gate_run");
  ...
  let spelled2169 = fn_name("bible_usfm_version_chapter_clipboard_copy_numbered");
  ...
  let spelled2186 = fn_name("bible_glyph_chapters_verse_marks_underdrawn_lines");
  ...
  let spelled2196 = fn_name("bible_usfm_chapter_paragraphed_text_cases_gate_run");
  let spelled2197 = fn_name("bible_audio_verses_manifest_write_all");
  let spelled2198 = fn_name("function_reachable_bytes_ranked");
  let spelled2199 = fn_name("bible_glyph_chapters_verse_marks_underdrawn_baseline_write");
  ...
  let spelled2205 = fn_name("ebible_versions_english_choices_commercial_gate_run");
  let spelled2206 = fn_name("bible_contraction_verses");
  let spelled2207 = fn_name("bible_glyph_chapter_rosetta_lines_fetched_gate_run");
  ...
  let spelled2210 = fn_name("bible_glyph_chapters_collision_marks_ambiguous_lines");
  let spelled2211 = fn_name("bible_glyph_chapters_collision_marks_baseline_write");
  ...
  let spelled2226 = fn_name("bible_glyph_chapter_tagalog_verses_fetched_gate_run");
  ...
  let spelled2229 = fn_name("bible_glyph_chapters_collision_marks_unseated_lines");
  ...
  let spelled2236 = fn_name("app_shared_text_reader_carried_unpicked_baseline_write");
  ...
  let spelled2251 = fn_name("app_en_learn_bible_gloss_urdu_unpublished_gate_run");
  ...
  let spelled2274 = fn_name("bible_glyph_chapters_verse_marks_underdrawn_walked");
  ...
  let spelled2285 = fn_name("firebase_storage_download_json_decompress_project_jg");
  ...
  let spelled2356 = fn_name("function_span_cut_named_skip_decided_or_null_cases_gate_run");
  ...
  let spelled2410 = fn_name("js_ast_return_key_shapes_disagreeing_cases_gate_run");
  ...
  let spelled2417 = fn_name("bible_usfm_versions_english_public_domain_download");
  ...
  let spelled2421 = fn_name("functions_calls_named_literal_argument_callee_set");
  ...
  let spelled2461 = fn_name("bible_usfm_version_chapter_clipboard_copy_plain_whitespace_normalized");
  ...
  let spelled2473 = fn_name("bible_glyph_chapters_collision_marks_baseline_path");
  let spelled2474 = fn_name("webpack_watch_bundle_stale_is");
  let spelled2475 = fn_name("g_arc_feedback_person_standing");
  let spelled2476 = fn_name("qa_promoted_public_pieces_served_is_cases_gate_run");
