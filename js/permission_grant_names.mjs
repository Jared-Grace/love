...
export function permission_grant_names() {
  ...
  let spelled2508 = fn_name("bible_glyph_chapters_verse_marks_underdrawn_baseline_path");
  ...
  let spelled2515 = fn_name("app_original_bible_gloss_words_unicode_repair_all");
  ...
  let spelled2525 = fn_name("app_ceb_bible_gloss_passages_respell_reader_price");
  ...
  let spelled2528 = fn_name("app_ceb_bible_gloss_passages_respell_refused_baseline_write");
  let spelled2529 = fn_name("app_ceb_bible_gloss_passages_respell_refused_gate_run");
  let spelled2530 = fn_name("app_ceb_bible_gloss_passages_respell_refused_names");
