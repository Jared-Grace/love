...
export function permission_grant_names() {
  ...
  let spelled2480 = fn_name("app_message_download_private_missing");
  let spelled2481 = fn_name("app_ceb_bible_gloss_affix_kinds_words_spread");
  let spelled2482 = fn_name("app_ceb_bible_gloss_affix_kinds_wrong_words");
  let spelled2483 = fn_name("bible_glyph_chapters_bands_missing_repair");
  let spelled2484 = fn_name("firebase_prod_asset_download_or_null");
  let spelled2485 = fn_name("public_chunks_orphaned_names_walked");
  let spelled2486 = fn_name("apps_published_dev_missing_walked");
  let spelled2487 = fn_name("app_en_learn_bible_gloss_urdu_chapters_uploaded");
  let spelled2488 = fn_name("song_images_kept_urls");
  let spelled2489 = fn_name("qa_promoted_piece_app");
  let spelled2490 = fn_name("bible_glyph_chapter_urdu_verses_fetched_gate_run");
  let spelled2491 = fn_name("function_imports_missing");
  let spelled2492 = fn_name("berean_book_chapters_verses");
  let spelled2493 = fn_name("app_en_learn_bible_gloss_urdu_unpublished_upload");
  let spelled2494 = fn_name("app_en_learn_bible_gloss_urdu_generate_download");
  let spelled2495 = fn_name("bible_glyph_chapter_rosetta_lines_file_source");
  let spelled2496 = fn_name("web_assets_folder");
  let spelled2497 = fn_name("web_assets_song_folder_name");
  let spelled2498 = fn_name("g_tiles_wall_faces_groups");
  let spelled2499 = fn_name("bible_glyph_chapters_urdu");
  let spelled2500 = fn_name("folder_repo_love_public");
  let spelled2501 = fn_name("apps_names_file_path");
  let spelled2502 = fn_name("bible_glyph_chapter_urdu_verses");
  let spelled2503 = fn_name("bible_glyph_chapter_urdu_verses_fetched");
  let spelled2504 = fn_name("app_original_bible_gloss_unpublished_upload");
  let spelled2505 = fn_name("app_message_download_private");
  let spelled2506 = fn_name("functions_locals_unread_baseline_path");
  let spelled2507 = fn_name("qa_promoted_publish_imports_gate_run");
  let spelled2508 = fn_name(
    "bible_glyph_chapters_verse_marks_underdrawn_baseline_path",
  );
  let spelled2509 = fn_name("qa_gate_timings_coverage_floor");
  let spelled2510 = fn_name("bible_verse_end_is");
  let spelled2511 = fn_name("qa_gates_countless_baseline_path");
  let spelled2512 = fn_name("function_imports_bundled");
  let spelled2513 = fn_name("app_en_learn_bible_gloss_urdu_passages_words");
  let spelled2514 = fn_name("gloss_root_claimed_shape");
  let spelled2515 = fn_name(
    "app_original_bible_gloss_words_unicode_repair_all",
  );
  let spelled2516 = fn_name("gloss_root_claimed_backing_gate_run");
  let spelled2517 = fn_name("ai_git_noted");
  let spelled2518 = fn_name("app_ceb_bible_gloss_explains_repair_silent");
  ...
  let spelled2524 = fn_name("app_ceb_bible_gloss_passages_respell_refused");
  let spelled2525 = fn_name(
    "app_ceb_bible_gloss_passages_respell_reader_price",
  );
  let spelled2526 = fn_name("functions_span_cut_all_starts_with");
  let spelled2527 = fn_name("app_ceb_bible_gloss_chapters_absent_gate_run");
  let spelled2528 = fn_name(
    "app_ceb_bible_gloss_passages_respell_refused_baseline_write",
  );
  let spelled2529 = fn_name(
