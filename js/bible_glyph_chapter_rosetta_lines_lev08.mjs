export function bible_glyph_chapter_rosetta_lines_lev08() {
  ...
  let chapter = {
    ...
    verses: [
      ...
      {
        verse_number: 3,
        original: "וְאֵ֥ת כָּל־ הָעֵדָ֖ה הַקְהֵ֑ל אֶל־ פֶּ֖תַח אֹ֥הֶל מוֹעֵֽד׃",
        english:
      ...
      {
        verse_number: 32,
        original: "וְהַנּוֹתָ֥ר בַּבָּשָׂ֖ר וּבַלָּ֑חֶם בָּאֵ֖שׁ תִּשְׂרֹֽפוּ׃",
        english: "Then you must burn up the remainder of the meat and bread",
      },
      {
        verse_number: 33,
        original:
