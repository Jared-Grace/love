...
import { gloss_explains_repeated_baseline_growth_assert } from "./gloss_explains_repeated_baseline_growth_assert.mjs";
import { gloss_explains_repeated_baseline_path } from "./gloss_explains_repeated_baseline_path.mjs";
import { baseline_known_write } from "./baseline_known_write.mjs";
export async function gloss_explains_repeated_baseline_write() {
  "Rewrite the record of how many gloss explanations were handed to a word some other word in the same chapter had already been given word for word, from what the stores hold right now.";
  ...
  await gloss_explains_repeated_baseline_growth_assert(counts);
