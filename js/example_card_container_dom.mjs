...
("The blue card surface every example sits on — the medium step of the graduated blue nesting (light outer frame -> medium example card), matching the search app.");
