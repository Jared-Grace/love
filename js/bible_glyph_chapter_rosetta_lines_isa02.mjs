export function bible_glyph_chapter_rosetta_lines_isa02() {
  ...
  let chapter = {
    ...
    verses: [
      ...
      {
        verse_number: 5,
        original: "בֵּ֖ית יַעֲקֹ֑ב לְכ֥וּ וְנֵלְכָ֖ה בְּא֥וֹר יְהוָֽה׃",
        english: "Come O house of Jacob let us walk in the light of the LORD",
      },
      {
        verse_number: 6,
        original:
      ...
      },
      {
        ...
        english: "against all the tall mountains against all the high hills",
      },
      {
        verse_number: 15,
        original:
          "וְעַ֖ל כָּל־ מִגְדָּ֣ל גָּבֹ֑הַ וְעַ֖ל כָּל־ חוֹמָ֥ה בְצוּרָֽה׃",
        english: "against every high tower against every fortified wall",
      },
      {
        verse_number: 16,
        original:
      ...
      {
        verse_number: 18,
        original: "וְהָאֱלִילִ֖ים כָּלִ֥יל יַחֲלֹֽף׃",
        english: "and the idols will vanish completely",
      },
      {
        verse_number: 19,
        original:
