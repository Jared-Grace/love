...
export function lyric_video_pictures_credit_line(paintings, drawn) {
  ...
  "★ IT SAYS THE PAINTERS ARE NAMED IN THIS DESCRIPTION AND NOT WHERE IN IT. Under a song the list sits at the foot, where length costs nothing; under a Psalm the verses are cut from the foot, so the list has to sit in the heading instead. One sentence serves both, and it can only do that by saying the true part - that they are named - rather than a place that is right in one caller and wrong in the other.";
  "The painters are not named here. There may be twenty of them, and this sentence has to be short enough to sit at the top of a description where it cannot be cut off; the list of them goes wherever the caller's own cutting leaves it whole.";
  ...
  if (all) {
    let paintings_line =
      "All " +
      total +
      " pictures in this video are public domain paintings. Each painter and painting is named in this description.";
  ...
  let line =
    ...
    " of the " +
    total +
    " pictures in this video are public domain paintings, named in this description. The other " +
    drawn +
