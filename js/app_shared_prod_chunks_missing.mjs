...
export async function app_shared_prod_chunks_missing(app_name) {
  ...
  "Which folder is looked in, and why it is the running copy's own worked out from where this code sits rather than looked up, is said where the folder is named.";
