...
export function bible_word_voice_path_in(folder_name, voice_name, text) {
  "$plain folder_name";
  "$plain voice_name";
  "$plain text";
  "Where the clip of one Bible word said by one voice sits under one folder of the assets folder, so the ordinary clips and the slow ones are named by the same rule and only the folder differs.";
