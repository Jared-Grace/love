...
export function app_shared_bible_font_size() {
  ...
  "What comes out of storage goes through the migration for the same reason the reader next door does: a device that opened the bible under the old scheme has a count of pixels filed under this word, and the two are told apart by their size alone.";
  ...
  let factor = app_shared_font_size_stored_migrate(stored);
  return factor;
}
