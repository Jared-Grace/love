...
export function app_code_expression_node_truths_wanted(
  ...
  ("Which of the two gathers first is handed in as a side rather than worked out, because a line saying so with a pair of parentheses and a line saying so by which operator is the stronger are the same shape and are told apart nowhere but here.");
