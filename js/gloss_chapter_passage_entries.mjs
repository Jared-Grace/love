...
export async function gloss_chapter_passage_entries(
  ...
  "The word explanations already stored for one passage of one gloss store, or nothing where that passage has not been written yet.";
  ...
  "It is also how a run of explanations is put back in the right place. The reader that finds a fault counts in words, and a splice counts in explanations - and one explanation may name several words at once, so the two numbers are not the same number. Reading the explanations is what turns the one into the other.";
