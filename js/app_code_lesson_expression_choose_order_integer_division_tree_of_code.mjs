...
export function app_code_lesson_expression_choose_order_integer_division_tree_of_code(
  code,
) {
  arguments_assert(arguments, 1);
  ("the shape behind a line this lesson printed, worked out again from the line itself: Math.floor(17 / 5) gives back the shape whose division is 17 over 5");
  ...
  ("Two numbers are the whole of what a line of this kind was built from, so the first two on it are read and the rest of the line is not consulted.");
