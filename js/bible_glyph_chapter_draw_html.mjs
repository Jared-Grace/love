...
export function bible_glyph_chapter_draw_html(parent, chapter, traditions) {
  ...
  ("THE VERSE NUMBER IS DRAWN AS TEXT AND STAYS TEXT, and it is the one thing on the line that is not a picture. IT IS DRAWN IN GREY AND THE PICTURES ARE NOT, because a number is how a reader finds their place rather than part of what the verse says - and set as loudly as what follows it, a number at the head of a line of pictures reads as the first word of the verse. A number has no reading in another language to lose - a person who cannot read a word of English can still find verse fourteen - so drawing it as a picture would spend a glyph on the one word that never needed one.");
