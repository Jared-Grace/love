...
export function app_code_expression_node_right_operator_first_parenthesis_wrapped(
  ...
  ("three given values with a given operator after the first and a given operator between the last two, built into the shape where the RIGHT of the two operators gathers its sides first and its pair of parentheses is written whether or not it changes anything: false && (true || true)");
  ...
  let second_node = app_code_expression_node_parenthesis_wrapped(
    middle,
    second_symbol,
    right,
  );
