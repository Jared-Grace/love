export function bible_glyph_chapter_rosetta_lines_lev07() {
  ...
  let chapter = {
    ...
    verses: [
      {
        verse_number: 1,
        original: "וְזֹ֥את תּוֹרַ֖ת הָאָשָׁ֑ם קֹ֥דֶשׁ קָֽדָשִׁ֖ים הֽוּא׃",
        english: "Now this is the law of the guilt offering which is most holy",
      },
      {
        verse_number: 2,
        original:
