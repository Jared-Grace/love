...
export function list_places_set_copy(list, places, items) {
  ...
  ("It is the putting-down that answers the picking-up: what ",
    fn_name("list_places_get"),
    " gathered from these places can be dealt back to them in any order, and everything else in the line stays exactly where it was.");
