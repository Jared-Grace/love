...
import { app_a_variable_declaration } from "./app_a_variable_declaration.mjs";
import { app_a_function_declaration } from "./app_a_function_declaration.mjs";
import { app_a_if_statement } from "./app_a_if_statement.mjs";
import { list_last_not_is } from "./list_last_not_is.mjs";
import { object_replace } from "./object_replace.mjs";
import { js_parse_expression } from "./js_parse_expression.mjs";
import { js_unparse } from "./js_unparse.mjs";
import { property_set } from "./property_set.mjs";
import { app_a_literal } from "./app_a_literal.mjs";
import { html_span } from "./html_span.mjs";
import { app_a_raw } from "./app_a_raw.mjs";
import { app_a_symbol_text_template } from "./app_a_symbol_text_template.mjs";
import { each_pair_or_null } from "./each_pair_or_null.mjs";
...
import { app_a_identifier } from "./app_a_identifier.mjs";
import { not } from "./not.mjs";
import { null_not_is } from "./null_not_is.mjs";
import { a_brackets_wrap } from "./a_brackets_wrap.mjs";
import { text_pad_space } from "./text_pad_space.mjs";
import { app_a_comma } from "./app_a_comma.mjs";
...
import { app_a_semicolon } from "./app_a_semicolon.mjs";
...
export function app_a_function_node(a) {
  ...
  if (n) {
    log_keep(app_a_function_node.name, {
      node,
    });
    let json = json_to({
      type,
