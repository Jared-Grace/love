...
import { bible_interlinear_folder_chapters } from "./bible_interlinear_folder_chapters.mjs";
...
export async function bible_interlinear_chapters_all_upload() {
  ...
  let read = await bible_interlinear_folder_chapters();
  let bible_folder = property_get(read, bible_folder_key());
