...
export async function app_original_bible_gloss_verse_claims_wrong_baseline_growth_assert(
  known,
) {
  "Refuse to record an original-language explanation naming an unrelated verse that the record did not already hold.";
  "The record starts at what the store already holds rather than empty, and every one of them wants a person. Each is a sentence naming a verse that carries no word with the same Strong's number, and only a reader can say whether it claims the word stands there - which would be wrong - or points at some other word standing there, or says the word was absent from it, both of which are right and arrive looking identical from outside.";
