...
export async function app_shared_text_reader_carried_unpicked_gate_run() {
  ...
  "HOW MANY CARRIED WORDS WERE WALKED UP TO TRAVELS OUT WITH THE VERDICT. A ratchet finding nothing new says the same word whether every screen was opened and none had grown, or the list of apps that promised a reader language came back empty and no screen was opened at all. The offenders are pinned at whatever the record already held and cannot fall; the count of words reached can.";
