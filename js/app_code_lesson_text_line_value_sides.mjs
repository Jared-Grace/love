...
export function app_code_lesson_text_line_value_sides(text) {
  ...
  ("One operator is enough for the question to exist, unlike the parentheses, which need two before they change anything. false === 5 shows a value on the left as plainly as any longer line does, so counting it keeps the telling as wide as it truly is.");
