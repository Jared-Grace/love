export function baseline_growth_guarded_cases() {
  ...
  let cases = [
    {
      imports: ["baseline_known_growth_assert", "baseline_known_write"],
      guarded: true,
      why: "the shared refusal most of the family calls, named plainly",
    },
    {
      imports: ["baseline_growth_assert_generic", "names_versus_baseline"],
      guarded: true,
    ...
    {
      imports: ["functions_duplicates_baseline_growth_assert"],
      guarded: true,
      why: "a family's own named wrapper, where the words sit in the middle of a longer name",
    },
    {
      imports: ["baseline_known_write", "duplicates_baseline_path"],
      guarded: false,
    ...
    {
      imports: ["baseline_known_read", "list_sort_text"],
      guarded: false,
