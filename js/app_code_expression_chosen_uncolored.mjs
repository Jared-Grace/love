...
export function app_code_expression_chosen_uncolored(component) {
  ...
  ("take the blue colouring off a piece and leave everything else about it alone - its fill goes and its lettering goes back to the colour of whatever it is standing in");
