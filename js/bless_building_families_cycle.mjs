...
export function bless_building_families_cycle() {
  ...
  ("That agreement is proved rather than trusted, in the one place every such run is proved. Change either number without the other and the game stops on the spot, rather than drawing a house with three doors that the prayer believes has two.");
  let cycle = [3, 2, 4, 3, 3];
