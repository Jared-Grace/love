...
export function g_content_backup_namespaces() {
  "Every folder in storage holding writing the game did itself - the sermons, the objections, the arc lengths and the written arcs.";
  ...
  let f_name5 = g_arc_write_upload_namespace();
  let namespaces = [f_name, f_name2, f_name3, f_name4, f_name5];
  return namespaces;
}
