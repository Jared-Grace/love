...
export function g_content_backup_namespaces() {
  "Every folder in storage that the game's own written content lands in - the sermons, the objections, the arc lengths, and the reviewer's marks on them.";
  ...
  let namespaces = [f_name, f_name2, f_name3, f_name4, t, t2];
  return namespaces;
}
