...
export function js_visit_above(v) {
  ...
  "This hands back whatever is directly above, which may be a node or may be the list a node keeps its children in. Ask js_stack_node_above instead for the nearest real node, which walks past those lists.";
