export function song_image_couplets() {
  ...
  let couplets = [
    ...
    },
    {
      ...
      second: "HIS only SON",
      symbol:
        "A ram with white horns, its horns held fast in three or four stout brown branches and no more, the branches set with long sharp thorns and wound around and between the horns so that the head cannot come free",
      ref: "Genesis 22",
      same_as: 0,
    },
    {
