export function song_image_couplets() {
  ...
  let couplets = [
    ...
    },
    {
      ...
      symbol:
        "A wall of plain grey rock with the doorway of a tomb cut into it, the doorway one plain flat black upright shape, and one very great round stone standing on its edge to the right of that doorway - a solid slab of plain grey stone with nothing at all at its middle, its foot on the ground and its top higher than the top of the doorway, its left edge already crossing a third of the way over the doorway with the rest of the black still open beside it - and the ground below one plain flat pale grey",
