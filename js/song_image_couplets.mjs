export function song_image_couplets() {
  ...
  let couplets = [
    ...
    },
    {
      ...
      second: "HIS only SON",
      symbol:
        "A whole ram standing side-on in strict profile with all four legs beneath it and its head turned to one side, never seen from the front and never a head on its own, its white horns held fast in three or four stout brown thorn branches that wind around and between the horns so that its head cannot come free",
      ref: "Genesis 22",
      same_as: 0,
    },
    {
