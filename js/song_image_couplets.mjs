export function song_image_couplets() {
  ...
  "a size asked for as a comparison has two sides, and the cheaper side is the one to push. Couplet 21 needed a stone big enough to seal the mouth, and taller than the doorway was ignored four times running; said three ways over it was obeyed and broke the window doing it, because every clause spent on the symbol is a clause taken off the field. Making the doorway low and narrow instead set the very same ratio and added nothing, and the stone came back larger than the opening with the four sheets of glass still whole behind it. When a thing will not grow, shrink what it is measured against.";
  let couplets = [
    {
      n: 1,
      verse: 1,
