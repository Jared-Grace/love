export function bible_glyph_chapter_rosetta_lines_luk02() {
  ...
  let chapter = {
    ...
    verses: [
      ...
      },
      {
        ...
        english: "And everyone went to his own town to register",
      },
      {
        verse_number: 4,
        original:
      ...
      {
        verse_number: 5,
        original: "ἀπογράψασθαι σὺν Μαριὰμ τῇ ἐμνηστευμένῃ αὐτῷ οὔσῃ ἐγκύῳ",
        english:
      ...
      },
      {
        ...
        english: "While they were there the time came for her Child to be born",
      },
      {
        verse_number: 7,
        original:
      ...
      },
      {
        ...
        english: "Simeon took Him in his arms and blessed God saying",
      },
      {
        verse_number: 29,
        original:
      ...
      {
        verse_number: 30,
        original: "ὅτι εἶδον οἱ ὀφθαλμοί μου τὸ σωτήριόν σου",
        english: "For my eyes have seen Your salvation",
      },
      {
        verse_number: 31,
        original: "ὃ ἡτοίμασας κατὰ πρόσωπον πάντων τῶν λαῶν",
        english: "which You have prepared in the sight of all people",
      },
      {
        verse_number: 32,
        original: "φῶς εἰς ἀποκάλυψιν ἐθνῶν καὶ δόξαν λαοῦ σου Ἰσραήλ",
        english:
      ...
      {
        verse_number: 50,
        original: "καὶ αὐτοὶ οὐ συνῆκαν τὸ ῥῆμα ὃ ἐλάλησεν αὐτοῖς",
        english:
