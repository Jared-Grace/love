export function claude_md_size_ceiling() {
  ...
  "Set at 78000 when the file weighed 77232, which was a tripwire rather than a ratchet - under a thousand bytes of room, less than one paragraph, for ten Claudes sharing the file. Moving the transform vocabulary into a note of its own took it to about 37000, and the number below is chosen against that: real room to work in, at half the size, rather than wherever the file happened to be left.";
  let bytes = 40000;
  return bytes;
}
