...
export async function urdu_glued_words_candidates(bigram_least) {
  ...
  "$plain bigram_least";
  "how much of the spaced spelling counts as evidence: a number, and nothing that runs. Asking it low finds more and offers more that is really one word; asking it high finds only the plainest cases.";
  ...
  let candidates = words_glued_candidates(words, bigrams, bigram_least);
  return candidates;
}
