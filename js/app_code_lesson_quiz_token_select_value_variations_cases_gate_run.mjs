import { app_code_lesson_quiz_token_select_value_variations_cases } from "./app_code_lesson_quiz_token_select_value_variations_cases.mjs";
...
export function app_code_lesson_quiz_token_select_value_variations_cases_gate_run() {
  ...
  let cases = app_code_lesson_quiz_token_select_value_variations_cases();
  function answer(c) {
