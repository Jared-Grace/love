...
export function app_g_arcs_field_shaped(
  ...
  "$plain shape";
  "$plain voice_color";
  "One filled field of a written arc drawn as a row: what the field is called down the left, and what was written in it drawn in the shape of the kind of thing it is. The row is handed back so that whoever asked for it can mark it afterwards.";
  ...
  "WHAT A LINE USED TO SAY IS ITS OWN KIND AND IS NOT AN ASIDE. It was drawn as one, at the weight the page uses for a footnote, and a reviewer skimming a whole arc went straight past every one of them - which is the opposite of what a previous wording is on the page to do. It is the second half of a comparison, so it is drawn to be read, boxed in the mark colour so that it is found without being hunted for.";
  ...
  let styles = {
    ...
    was: {
      flex: "1 1 11rem",
      "line-height": "1.45",
      "background-color": "rgba(180,83,10,0.09)",
      "border-left": "3px solid rgba(180,83,10,0.55)",
