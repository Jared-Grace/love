...
export async function gloss_chapter_words_misaligned(
  chapter_code,
  fn,
  words_read,
) {
  ...
  function passage_read(passage) {
    let r = gloss_passage_words_misaligned(passage, words_read);
    return r;
  }
  let misaligned = list_map_filter_null_not_is(passages, passage_read);
  let r2 = {
    chapter_code,
