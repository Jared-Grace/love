export function bible_glyph_chapter_rosetta_lines_gen06() {
  ...
  let chapter = {
    ...
    verses: [
      ...
      {
        verse_number: 8,
        original: "וְנֹ֕חַ מָ֥צָא חֵ֖ן בְּעֵינֵ֥י יְהוָֽה׃פ",
        english: "Noah, however, found favor in the eyes of the LORD",
      },
      {
        verse_number: 9,
        original:
      ...
      },
      {
        ...
        english: "And Noah had three sons Shem Ham and Japheth",
      },
      {
        verse_number: 11,
        original:
      ...
      },
      {
        ...
        english: "So Noah did everything precisely as God had commanded him",
      },
    ],
  };
  return chapter;
