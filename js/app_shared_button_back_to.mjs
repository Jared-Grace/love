...
export function app_shared_button_back_to(container, destination, lambda) {
  "A way out that names where it leads, drawn the same way as the plain one beside it - the twin of app_shared_button_back for the screens that know their destination.";
