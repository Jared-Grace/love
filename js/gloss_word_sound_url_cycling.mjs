...
export function gloss_word_sound_url_cycling(url_get, slow_get) {
  "Hands back two ways of asking for one word's recording: an ordinary one, which answers in a different person's voice every time it is asked, and a slower one, which answers in the person that word was just heard from.";
  ...
  function voice_heard(word) {
    let remembered = property_get(spoken, word);
