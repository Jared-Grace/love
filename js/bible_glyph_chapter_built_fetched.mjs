...
export async function bible_glyph_chapter_built_fetched(chapter_code) {
  ...
  ("The lookup is ",
    fn_name("bible_glyph_testament_drawn"),
    "'s, so an Old Testament chapter also draws the small parts joined to a Hebrew word, such as and, in and his, wherever the chapter keeps them.");
  ...
  let tables = await import("./bible_glyph_testament_drawn.mjs");
  let drawn = tables.bible_glyph_testament_drawn(testament_name);
