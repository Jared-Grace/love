...
export function js_code_not_parenthesis_wrapped(item) {
  ("the code !(x) - the given code gathered into brackets and then given a not in front of it. The exact twin of ",
    fn_name("js_code_negation_parenthesis_wrapped"),
    ", which is the same two steps with a minus.");
