...
export async function qa_promoted_unjudged() {
  ...
  "Four ways to be an offender and they are kept apart, because the thing to do about each is different: nothing was written down about where the pieces came from, or something was but the pieces have since changed, or the commit it names is not here any more, or the pieces did come out of a named commit and that commit was not sound for this app";
