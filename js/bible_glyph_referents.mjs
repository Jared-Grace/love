...
export function bible_glyph_referents() {
  ...
  ("A word usually earns one glyph, and ",
    fn_name("bible_glyph_roots"),
    " gives it one. A few do not, and the survey found them rather than anyone predicting them. The same word Iesous is Jesus eight hundred and forty seven times and Joshua three times, so a cross drawn on all of them puts a cross on Joshua. The same word anthropos is a human being and is also half of the title Son of Man.");
