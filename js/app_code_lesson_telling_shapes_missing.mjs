...
export async function app_code_lesson_telling_shapes_missing() {
  ...
  ("Shape is two marks, not one, and a lesson misses the check if either goes unshown. One is whether the line is bracketed or flat. The other is which end a true or a false sits at, because a value on the left reads as a different question from the same value on the right.");
