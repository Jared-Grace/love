...
// Writes the PROD static page only. Dev is now the client app (app_examples: a
// webpack bundle + shell page that fetches examples_data.json), so writing a
// static dev page here would clobber it. Prod stays static until it too becomes
// the app.
