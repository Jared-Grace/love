export async function g_plant_chapters() {
  ...
  "How many plants a book makes is chosen by searching the counts rather than by dividing its length by the wanted one - see g_plant_book_count for why those differ, and for the book that rounding got wrong.";
