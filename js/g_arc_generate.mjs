...
export async function g_arc_generate() {
  ...
  "The sizing and the seeding are the drawing's own business and live with the drawing, so that a reader asking who the pool holds does not have to come through the writer to find out.";
