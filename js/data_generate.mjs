...
export async function data_generate(data) {
  ...
  "The fold used to be described as cheap and done every time. It is not cheap - a hundred and forty thousand names go into lookups, and it measured at more than half of what asking for the index costs at all. Whoever wants it done once per process asks data_index_get instead; this one always folds, for the caller that wants a fresh object of its own.";
