...
export async function lyric_video_document_pictures_model_bench_attempts_plain(
  ...
  "$plain model";
  "$plain attempts";
  "Draws every scene an authored document asks for several times over on one model, sending nothing but the wording, so that a model which cannot be steered can still be counted.";
