...
export async function commons_pictures_search(words, count) {
  ...
  "It answers null rather than throwing when the far end will not talk, so a walk over many scenes is not ended by one bad minute on somebody else's server.";
