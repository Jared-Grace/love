import { firebase_folder_seams_caller_walk } from "./firebase_folder_seams_caller_walk.mjs";
...
export async function firebase_folder_seams() {
  ...
  while (waiting) {
    ...
    if (uncalled) {
      ...
      waiting = greater_than(a, asked);
      continue;
    }
    await firebase_folder_seams_caller_walk(
      callers,
      builder,
      index,
      known,
