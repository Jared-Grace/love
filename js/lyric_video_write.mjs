import { audio_duration } from "./audio_duration.mjs";
...
export async function lyric_video_write(
  ...
  "The instruction goes over as a list of words rather than as a line of text. A subtitle instruction carries brackets and an equals sign, and a line of text holding those cannot be split back into words safely, so it would be unsendable.";
  let duration = await audio_duration(path_audio);
