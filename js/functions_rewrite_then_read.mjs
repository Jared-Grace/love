...
export async function functions_rewrite_then_read() {
  ...
  ("Every function that has a named function written out again and then, in the same run, calls something that reads it - each named beside the pairings that say so.");
  ...
  function kept_lambda(candidate) {
    ...
    let stale = list_filter(pairs, stale_is);
