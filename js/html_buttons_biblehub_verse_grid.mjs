...
export function html_buttons_biblehub_verse_grid(parent) {
  "a centered two-column grid for the multi-verse biblehub link-kinds: left column holds the right-aligned labels, right column holds the verse-number buttons, so the numbers line up across Commentary / Parallel / Interlinear. Each html_buttons_biblehub_verse_group call fills one row (a label cell + a buttons cell)";
