...
export function app_code_lesson_name_quoted_letter_line(
  ...
  ("The cup names wear the colour they wear in the program above, and the letter inside the quote marks does not - which is the whole difference this line draws, drawn a second way. The name of the cup is coloured and the same letter as a value is left white.");
  ...
  app_code_span_code_dark_names(line, name_source, names);
  html_span_text(line, " had quote marks ");
  html_span_text_code_dark(line, quote);
  html_span_text(line, " around it ");
  app_code_span_code_dark_names(line, line_quoted, names);
