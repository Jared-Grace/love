...
export function app_code_expression_node_left_operator_first_parenthesis_wrapped(
  left,
  first_symbol,
  middle,
  second_symbol,
  ...
  let first_node = app_code_expression_node_parenthesis_wrapped(
    left,
    first_symbol,
    middle,
  );
