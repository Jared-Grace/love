...
import { js_query_key_literals_cases } from "./js_query_key_literals_cases.mjs";
import { js_query_key_literals } from "./js_query_key_literals.mjs";
import { list_map_property } from "./list_map_property.mjs";
export function js_query_key_literals_cases_gate_run() {
  ...
  let cases = js_query_key_literals_cases();
  function answer(c) {
    let ast = property_js_parse(c, "code");
    let sites = js_query_key_literals(ast);
