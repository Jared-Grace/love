...
export async function bible_versions_english_choices_usable() {
  ...
  ("The eBible ones come first and keep the order that list is in, and each further shelf is added after the ones already here, so a comparison reading top to bottom is not reshuffled by a shelf being added.");
