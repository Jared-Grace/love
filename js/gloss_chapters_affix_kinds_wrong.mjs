...
export async function gloss_chapters_affix_kinds_wrong(fn, known) {
  "Every chapter of one gloss store holding an explanation that calls a piece of its word by a name the dictionary gives no piece of.";
