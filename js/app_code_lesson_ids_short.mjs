...
export function app_code_lesson_ids_short() {
  ...
  let short = {
    ...
    app_code_lesson_statement_name_count_watched: text_frozen("name_count_watched"),
    app_code_lesson_statement_name_one_more_watched: text_frozen("name_one_more_watched"),
    app_code_lesson_statement_name_one_less_watched: text_frozen("name_one_less_watched"),
    app_code_lesson_statement_name_itself_sum_watched: text_frozen("name_add_self_watched"),
    ...
    app_code_lesson_statement_name_not: text_frozen("name_not"),
    ...
    app_code_lesson_comment_after_code: text_frozen("comment_after"),
