...
export function g_verify_status_namespace() {
  ...
  "Named at all so the freeze list can watch it. Spelled where it was used, the one thing that could still go wrong - somebody retyping the word by hand - showed up as an ordinary edit to an ordinary line, and nothing anywhere said what had just moved.";
  let v = text_frozen("g_verify_status");
  return v;
}
