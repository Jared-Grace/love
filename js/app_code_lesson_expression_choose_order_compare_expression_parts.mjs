...
export function app_code_lesson_expression_choose_order_compare_expression_parts(
  ...
  ("The parentheses on the second shape are not written here and are not remembered anywhere. The shape says the comparison is one side of the outer operator, and a line that is printed back from the shape gathers whatever would otherwise be read in a different order - which on this shape is the comparison, because true === 3 < 5 would be taken as (true === 3) < 5.");
