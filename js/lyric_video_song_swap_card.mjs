...
export function lyric_video_song_swap_card(parent, document, swap, name) {
  ...
  let picture = list_find_property_or_null(pictures, "path", before); let gone = null_is(picture); if (gone) { let said = text_combine_multiple(["the song no longer has a picture at ", before]); app_shared_text_quiet(card, said); return card; }
