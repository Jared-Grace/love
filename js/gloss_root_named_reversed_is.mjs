...
export function gloss_root_named_reversed_is(word, root) {
  ...
  "★ FOUR OF THE FIVE MARKS HERE ARE REFUSALS AND ONLY ONE OF THEM WAS IN THE FIRST READING, WHICH IS WHY THE FIRST READING WAS WRONG BY 127 SIGHTINGS. The count it produced was 6715 and the count that survives all five is 6588. That is under two in a hundred, so the finding stands, but it stands measured rather than assumed - and every one of the three classes cut here was found by reading the least common answers rather than the most common ones, after the forty most common had come back clean.";
  "The headword refusal has to take the marks off both ends before it compares, and that single missing step was 61 of the 127. A word is filed in this store exactly as the person copying the verse saw it, so dios. and “ang and yahweh?” are stored spellings, and an explanation of dios. that opens by quoting dios is repeating the word rather than naming a root. Compared as typed the two are different text and the repetition reads as a discovery.";
  "The affix refusal is 60 more. An explanation may open by quoting the piece that was added rather than the thing it was added to - Taga- means from, Pag- makes it the doing of - and a piece is spelled inside the word for the same reason a root is, so containment cannot separate them. A dash on either end is the notation this repo already writes affixes in, so the refusal costs nothing to make and no root is written that way.";
  "The last refusal is the smallest at 6 sightings and the least certain. Where the word is two words - nating baka, labing halangdon - an opening quotation of the first of them is naming a part of the phrase, and a part of a phrase is not a root. It is refused because this reader answers about roots, not because the sentence is wrong.";
  "$plain word";
