...
export function app_index_categories_show(context, entries) {
  ...
  "A page that hides things behind taps owes the reader an open-everything and shut-everything pair: somebody who wants to see every app, or to find one with their browser's own search, cannot do either while the groups are shut. The pair sits BELOW the groups, asked for by name on 2026-09-23, so the group names are the first thing on the screen; it is made after the groups are shut, so it shows the shut state from the start.";
  ...
  html_p_text_centered(root, "All public apps and links on this site:");
