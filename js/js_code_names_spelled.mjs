...
export function js_code_names_spelled(f_name, note, names) {
  "the source of a function that answers a list of spelled function names, already in the shape the normalize pass would leave it in, so generating it and normalizing it agree";
