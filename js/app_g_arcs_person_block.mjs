...
export function app_g_arcs_person_block(parent, person, bench) {
  "One written arc drawn for review: who the person is, whether it has been read before and what has moved since, a row for filing a note against the person themselves, and every conversation of theirs as a box holding its own turns.";
  ...
  "WHETHER IT HAS BEEN READ IS SAID AT THE TOP AND ONLY THERE. Every marked line further down means what it means because of that one sentence - on an arc nobody has read there are no marks at all, and an unmarked page would otherwise be read as an arc nothing has moved in.";
  ...
  "THE CONVERSATION HEADING STANDS OUTSIDE THE TURN CARD, because it stands over several cards and a card drawing its own would repeat it down the page. It carries the catch-up, which is what happened to the person between conversations and is the only thing on the page that is not somebody speaking to them.";
  ...
  function field_line(one) {
    ...
    app_g_arcs_field_was(block, person_moved, name, voice_color);
  }
