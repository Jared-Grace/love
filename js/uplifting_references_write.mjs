...
export async function uplifting_references_write() {
  "write the deduped list of uplifting verse references to firebase-served data, so the verses app fetches which verses to draw from (via uplifting_references_get) instead of baking the list into its bundle. Run this whenever the authored list bible_verses_uplifting changes.";
