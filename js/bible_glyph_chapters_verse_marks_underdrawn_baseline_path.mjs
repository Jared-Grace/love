export function bible_glyph_chapters_verse_marks_underdrawn_baseline_path() {
  ...
  let path =
    "data/given/baselines/bible_glyph_chapters_verse_marks_underdrawn_baseline.json";
  return path;
}
