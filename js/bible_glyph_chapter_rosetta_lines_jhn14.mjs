export function bible_glyph_chapter_rosetta_lines_jhn14() {
  ...
  let chapter = {
    ...
    verses: [
      ...
      },
      {
        ...
        english:
          "And if I go and prepare a place for you back I will come and welcome you into My presence so that where am I also you may be",
      },
      {
        verse_number: 4,
        original: "καὶ ὅπου ἐγὼ ὑπάγω οἴδατε τὴν ὁδόν",
        english: "to the place where I am going You know the way",
      },
      {
        verse_number: 5,
        original:
      ...
      },
      {
        ...
        english:
          "answered Jesus I am the way and the truth and the life No one comes to the Father except through Me",
      },
      {
        verse_number: 7,
        original:
        ...
        english:
          "If you had known Me Father My From now on you do know Him and have seen",
      },
      {
        verse_number: 8,
        original:
        ...
        english:
          "said to Him Philip Lord show us the Father and that will be enough for us",
      },
      {
        verse_number: 9,
        original:
      ...
      },
      {
        ...
        english:
          "And whatever you ask in name My I will do so that may be glorified the Father in the Son",
      },
      {
        verse_number: 14,
      ...
      },
      {
        ...
        english: "If you love Me commandments My you will keep",
      },
      {
        verse_number: 16,
        original:
        ...
        english:
          "And I will ask the Father and another Advocate He will give you to be with you forever",
      },
      {
        verse_number: 17,
        original:
      ...
      },
      {
        ...
        english:
          "In a little while the world Me no more will see you but will see Me Because I live also you will live",
      },
      {
        verse_number: 20,
        original:
      ...
      },
      {
        ...
        english:
          "asked Him Judas (not Iscariot) Lord why to us are You going to reveal Yourself and not to the world",
      },
      {
        verse_number: 23,
        original:
        ...
        english:
          "replied Jesus If anyone loves Me word My he will keep Father My will love him and to him We will come and Our home with him make",
      },
      {
        verse_number: 24,
        original:
      ...
      },
      {
        ...
        english:
          "the But Advocate the Spirit Holy whom will send the Father in name My you will teach all things and will remind you of everything have told you I",
      },
      {
        verse_number: 27,
        original:
      ...
      },
      {
        ...
        english:
          "But so that may know the world that I love the Father exactly what has commanded Me the Father I do Get up Let us go on from here",
      },
    ],
  };
  return chapter;
