...
export async function baseline_writers_growth_unguarded() {
  ...
  "what counts as refusing is importing something whose name ends in growth assert. that is asked of the imports rather than of the whole reachable tree, because a writer that only reaches one through three other functions is not refusing anything itself";
