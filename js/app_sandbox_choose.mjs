...
export async function app_sandbox_choose(name) {
  ...
  "A NAME MAY CARRY A SECOND PART AFTER A SLASH, and only the part in front of the slash names the preview. The rest is the preview own business - which tab to open, which row to show - and it reads the address for itself.";
