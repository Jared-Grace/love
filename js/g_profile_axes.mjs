...
export function g_profile_axes() {
  ...
  "It also splits what free and freed had collapsed. Free says nothing about the past; the old pair carried the whole distinction on one letter, which is the kind of near-miss a reader blurs. Was a servant says the past outright.";
  ...
  let axes = {
    ...
    sons: counts,
    daughters: counts,
    servitude: ["free", "has servants", "is a servant", "was a servant"],
