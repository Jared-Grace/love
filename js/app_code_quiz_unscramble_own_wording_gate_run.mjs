...
export function app_code_quiz_unscramble_own_wording_gate_run() {
  ...
  "This one was paid for too, on the lesson whose whole subject is parentheses. The taught line was (3 === 5) === (5 === 3), eleven tiles, and the four orderings it would accept were nine tiles each and none of them began with a parenthesis. A learner who copied the line they had just been shown was marked wrong on their first press. Nothing was red: the tiles were writable, the accepted orderings all said the right thing, and every gate agreed.";
