export function bible_glyph_chapter_rosetta_lines_jhn03() {
    ...
    verses: [
      {
        ...
        english:
          "there was Now a man of the Pharisees Nicodemus named a leader of the Jews",
      },
      {
        verse_number: 2,
        original:
      ...
      },
      {
        ...
        english:
          "replied Jesus Truly truly I tell you unless one he is born again no can see the kingdom - of God",
      },
      {
        verse_number: 4,
        original:
        ...
        english:
          "asked - - - Nicodemus How can a man be born old when he is Can he - womb - mother’s his a second time enter - to be born",
      },
      {
        verse_number: 5,
        original:
      ...
      },
      {
        ...
        english:
          "- born of - flesh Flesh is [but] - born of the Spirit spirit is",
      },
      {
        verse_number: 7,
        original: "μὴ θαυμάσῃς ὅτι εἶπόν σοι Δεῖ ὑμᾶς γεννηθῆναι ἄνωθεν",
        english: "Do not be amazed that I said - must You be born again",
      },
      {
        verse_number: 8,
        original:
      ...
      },
      {
        ...
        english: "asked Nicodemus How can this be",
      },
      {
        verse_number: 10,
        original:
        ...
        english:
          "said Jesus You are - teacher - Israel’s and these things you do not understand",
      },
      {
        verse_number: 11,
        original:
        ...
        english:
          "Truly truly I tell you - of what we know we speak and to what we have seen we testify and yet - testimony our you people do not accept",
      },
      {
        verse_number: 12,
        original:
      ...
      },
      {
        ...
        english:
          "Just as Moses lifted up the snake in the wilderness so be lifted up must the Son - of Man",
      },
      {
        verse_number: 15,
        original: "ἵνα πᾶς ὁ πιστεύων ἐν αὐτῷ ἔχῃ ζωὴν αἰώνιον",
        english: "that everyone who believes in Him may have life eternal",
      },
      {
        verse_number: 16,
        original:
      ...
      },
      {
        ...
        english:
          "Whoever believes in Him is not condemned whoever does not believe has already been condemned because he has not believed in the name - one and only Son - of God’s",
      },
      {
        verse_number: 19,
        original:
        ...
        english:
          "this And is the verdict - The Light has come into the world but loved - men rather the darkness than the Light were because their evil - deeds",
      },
      {
        verse_number: 20,
        original:
      ...
      },
      {
        ...
        english: "replied John can A man receive is given him from - heaven",
      },
      {
        verse_number: 28,
        original:
        ...
        english:
          "yourselves You - can testify that I said not am I the Christ but - sent am ahead of Him",
      },
      {
        verse_number: 29,
        original:
      ...
      },
      {
        ...
        english:
          "what He has seen and heard to He testifies yet - testimony His no one accepts",
      },
      {
        verse_number: 33,
        original:
        ...
        english:
          "Whoever accepts His - testimony has certified that - God truthful is",
      },
      {
        verse_number: 34,
        original:
      ...
      {
        verse_number: 35,
        original: "Ὁ Πατὴρ ἀγαπᾷ τὸν Υἱόν καὶ πάντα δέδωκεν ἐν τῇ χειρὶ αὐτοῦ",
        english:
          "The Father loves the Son and all things has placed in - hands His",
      },
      {
        verse_number: 36,
        original:
        ...
        english:
          "Whoever believes in the Son has life eternal Whoever - rejects the Son will not see life Instead the wrath - of God remains on him",
      },
    ],
  };
  return chapter;
