...
export async function app_g_sky_jump(phase) {
  ("jump the sky straight to a chosen time-of-day PHASE (an integer index into ",
    g_times.name,
    ") — the #sky demo's choice panel calls this so you can inspect any sky without walking. writes + snaps + persists via app_g_sky_phase_write (the choice survives a refresh), then restyles the you-are-here pill");
