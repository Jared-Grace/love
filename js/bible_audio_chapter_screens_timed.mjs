...
export async function bible_audio_chapter_screens_timed(
  ...
  function line_each(line, order) {
    ...
    let long = greater_than(text.length, characters_max);
    if (long) {
  ...
  function screens_add(line, order) {
    ...
    let cut = lyric_video_words_screens(words, characters_max, seconds);
