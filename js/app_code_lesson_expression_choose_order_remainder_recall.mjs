...
export function app_code_lesson_expression_choose_order_remainder_recall(root, context) {
  ...
  let recall_card = app_code_lesson_expression_choose_order_strong_card(root, context);
  let words = app_code_division_formula_recall_words(
    "remainder",
    app_code_expression_remainder_tree,
  );
  app_code_remember_from_lesson(recall_card, context, app_code_lesson_expression_remainder_divide, words);
}
