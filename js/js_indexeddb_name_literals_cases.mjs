  ...
  let cases = [
    {
      doors,
      code: text_frozen(
        'let all = await indexeddb_get_all(download_cache_database, "downloads");',
      ),
      words: ["downloads"],
    ...
    },
    {
      doors,
      code: text_frozen(
        "let store = download_cache_store();\nlet all = await indexeddb_get_all(download_cache_database, store);",
      ),
      words: [],
    ...
    },
    {
      doors,
      code: text_frozen(
        'let database = await indexeddb_database_open("download_cache", "downloads");',
      ),
    ...
    },
    {
      doors,
      code: text_frozen(
        'let all = await ebible_offline_chapter_get("downloads");',
      ),
      words: [],
