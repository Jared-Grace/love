export function bible_glyph_chapter_rosetta_lines_jhn04() {
  ...
  let chapter = {
    ...
    verses: [
      ...
      {
        verse_number: 2,
        original: "καίτοιγε Ἰησοῦς αὐτὸς οὐκ ἐβάπτιζεν ἀλλ’ οἱ μαθηταὶ αὐτοῦ",
        english: "(although it was not Jesus who baptized but His disciples)",
      },
      {
        verse_number: 3,
        original: "ἀφῆκεν τὴν Ἰουδαίαν καὶ ἀπῆλθεν πάλιν εἰς τὴν Γαλιλαίαν",
        english: "He left Judea and returned to Galilee",
      },
      {
        verse_number: 4,
        original: "Ἔδει δὲ αὐτὸν διέρχεσθαι διὰ τῆς Σαμαρείας",
        english: "Now He had to pass through Samaria",
      },
      {
        verse_number: 5,
        original:
      ...
      {
        verse_number: 16,
        original: "Λέγει αὐτῇ Ὕπαγε φώνησον τὸν ἄνδρα σου καὶ ἐλθὲ ἐνθάδε",
        english: "Jesus told her Go call your husband and come back",
      },
      {
        verse_number: 17,
        original:
      ...
      {
        verse_number: 19,
        original: "Λέγει αὐτῷ ἡ γυνή Κύριε θεωρῶ ὅτι προφήτης εἶ σύ",
        english: "Sir the woman said I see that You are a prophet",
      },
      {
        verse_number: 20,
        original:
      ...
      {
        verse_number: 26,
        original: "Λέγει αὐτῇ ὁ Ἰησοῦς Ἐγώ εἰμι ὁ λαλῶν σοι",
        english: "Jesus answered I who speak to you am He",
      },
      {
        verse_number: 27,
        original:
      ...
      {
        verse_number: 30,
        original: "ἐξῆλθον ἐκ τῆς πόλεως καὶ ἤρχοντο πρὸς αὐτόν",
        english: "So they left the town and made their way toward Jesus",
      },
      {
        verse_number: 31,
        original: "Ἐν τῷ μεταξὺ ἠρώτων αὐτὸν οἱ μαθηταὶ λέγοντες Ῥαββί φάγε",
        english: "Meanwhile the disciples urged Him Rabbi eat something",
      },
      {
        verse_number: 32,
        original: "Ὁ δὲ εἶπεν αὐτοῖς Ἐγὼ βρῶσιν ἔχω φαγεῖν ἣν ὑμεῖς οὐκ οἴδατε",
        english:
      ...
      {
        verse_number: 41,
        original: "Καὶ πολλῷ πλείους ἐπίστευσαν διὰ τὸν λόγον αὐτοῦ",
        english: "And many more believed because of His message",
      },
      {
        verse_number: 42,
        original:
      ...
      {
        verse_number: 43,
        original: "Μετὰ δὲ τὰς δύο ἡμέρας ἐξῆλθεν ἐκεῖθεν εἰς τὴν Γαλιλαίαν",
        english: "After two days Jesus left for Galilee",
      },
      {
        verse_number: 44,
        original:
      ...
      },
      {
        ...
        english: "Sir the official said come down before my child dies",
      },
      {
        verse_number: 50,
        original:
