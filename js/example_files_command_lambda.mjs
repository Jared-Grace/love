...
("temp dir. function_rename / function_delete_unused are repo-wide/ambient, so the gate");
("proves their CROSS-FILE core via the hermetic js_identifiers_rename_dir / _delete_unused_dir.");
