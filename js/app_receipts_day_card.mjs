...
export function app_receipts_day_card(parent, title) {
  ...
  "The card is the palest blue of the shared cards, with a blue edge: much lighter than the blue a purchase can be marked with, and none of the purchase colours, so a purchase in any colour stands out against it rather than disappearing into it. What is put in it is spaced apart, so each purchase reads as a button of its own.";
