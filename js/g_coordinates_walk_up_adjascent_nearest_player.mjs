...
export function g_coordinates_walk_up_adjascent_nearest_player(
  ...
  "where the player should stand to be beside this - the nearest free ground next to it, and if every side of it is taken, the nearest ground next to it whoever is standing there.";
  ...
  let free = g_coordinates_walkable_adjascent_nearest_player(
    g,
    player,
    coordinates,
  );
