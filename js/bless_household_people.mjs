...
export function bless_household_people(household) {
  ...
  ("costs one division and a walk of three however far into the world the family sits.");
  ("The people of a family are still CONSECUTIVE, which is what keeps everything above this");
  ("working. They are a run inside their building's nine, and the runs of the three families");
