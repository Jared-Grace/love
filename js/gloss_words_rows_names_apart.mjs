...
export function gloss_words_rows_names_apart(rows, common_words) {
  ...
  "Measured 2026-09-06 over the 321 rows left in the Cebuano queue: 27 taken out, 25 of them proper names on sight, and the whole cost is two rows of one sighting each - Pakiglantugi and Gitak-opan, ordinary verbs capitalised only because they open their sentences. That is the trade, and it is taken deliberately, which is why the names come back whole rather than counted: this filter takes work off a person's list and the only way to trust it is to read what it took.";
