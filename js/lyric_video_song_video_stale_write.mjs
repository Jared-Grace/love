...
export async function lyric_video_song_video_stale_write(
  ...
  ("$plain path_audio");
  ("$plain path_document");
  ("Makes the lyric video of one song beside the song itself, and only when there is no video there or the video is older than something it was made from.");
