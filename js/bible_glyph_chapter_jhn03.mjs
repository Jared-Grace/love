export function bible_glyph_chapter_jhn03() {
  ...
  "THE OUTWARD HAND ARRIVED AFTER THIS CHAPTER WAS WRITTEN AND BOTH SENDINGS TOOK IT. Apostello was seated for the seventeenth of this gospel and every chapter already authored was then a chapter with a word standing in letters that could now be a picture. Both of this one are apostello - the twenty eighth is apestalmenos and the thirty fourth is apesteilen - and there is no pempo anywhere in it, which is what let the whole chapter be redrawn in one pass instead of a verse at a time.";
  let chapter = {
    chapter_code: "JHN03",
    reference: "John 3",
    verses: [
