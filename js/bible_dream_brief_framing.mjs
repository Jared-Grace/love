...
export function bible_dream_brief_framing() {
  ...
  "One passage has already been answered the other way and it is worth knowing about. At MAT27:19 the outcome IS the delivery: Pilate's wife wakes and sends word to him, and the words she sends are the passage's own, so the outcome is where a sentence gets carried and is played rather than watched. Whether that is the rule or that passage's peculiarity is not settled.";
