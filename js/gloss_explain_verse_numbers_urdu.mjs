...
export function gloss_explain_verse_numbers_urdu(explain, verse_numbers) {
  ...
  "No shutter is looked for either, and for the same reason. English needs them because the verse three times and a few verses two hands read exactly like in verses three and in verses two; Urdu has no word for the at all, and a sentence counting verses in Urdu spells the count in words rather than in the ten shapes, so the reading never opens on it. A word belongs on this list when a reading of this store shows one, not before.";
