...
export async function commit_edit_prose_touched_kind(commit) {
  ...
  "THREE ANSWERS RATHER THAN TWO. An edit that only touched prose is one a named verb would have made outright. An edit that touched prose beside code is one where a verb would have made part of it, and whether that is worth reaching for is a different question from the first. Keeping them apart is the whole reason for asking.";
