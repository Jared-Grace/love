...
export async function ebible_verses_texts(bible_folder) {
  "The wording of every verse of one downloaded translation, in one list, with nothing said about which verse each one is.";
  "$plain bible_folder";
  "which translation to read, spelled the way the download names it: a word, and nothing that runs.";
  "Anything asking what a translation does with a word has to see the whole of it. A defect that shows up eleven times in one book is a typing slip; the same defect standing in sixty places across sixty chapters is a habit, and only the whole book tells those apart.";
