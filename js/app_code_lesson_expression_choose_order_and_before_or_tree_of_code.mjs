...
export function app_code_lesson_expression_choose_order_and_before_or_tree_of_code(
  ...
  ("The hanging handed in is the one the operators would have chosen on their own, because that is what this lesson teaches. Reading the line back is the same work here as on the brackets lesson, so it is said once, next door.");
