export function bible_glyph_undrawn_wanted() {
  ...
  "IT HAS BEEN THROUGH TWO PASSES AND BOTH TIMES MOST OF THE LIST LEFT IT, WHICH IS THE POINT OF IT. Thirty three words were measured first and twenty nine of them came back clean and are seated now. Eighty five more were measured after that and fifty eight of those were seated too. Seventy five more went through a third time and twenty three of those were seated, after four came back out for wearing a picture that already meant something else and ten more came back out for sharing a picture with a sibling word. Every one went the same way - counted as plain English standing in a drawn verse, then looked up in the interlinear to see what Hebrew number it answers to and what share of that number it covers. What stays in this list is what the count refused, and nothing else.";
  ...
  "NOTHING IN THE MEASURING COULD HAVE CAUGHT THAT, but a gate already could have, and that is the more useful half of the story. The interlinear count answers whether one Hebrew number has one sense; it cannot answer whether some other number is already wearing the picture. A gate for exactly that question has been in the build the whole time, it calls a picture standing for two roots the worst fault the alphabet can have, and it names every offender in one run. It was not asked. Four wrong seats were then found by hand, and when the gate was finally run it named nine more that the hand reading had walked straight past. So the rule is two questions and not one - is the word one sense, and is the picture free - and the second question already has an answer waiting to be asked for.";
