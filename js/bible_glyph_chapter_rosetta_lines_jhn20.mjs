export function bible_glyph_chapter_rosetta_lines_jhn20() {
  ...
  let chapter = {
    ...
    verses: [
      ...
      },
      {
        ...
        english: "Then Peter and the other disciple set out for the tomb",
      },
      {
        verse_number: 4,
        original:
      ...
      {
        verse_number: 5,
        original: "καὶ παρακύψας βλέπει κείμενα τὰ ὀθόνια οὐ μέντοι εἰσῆλθεν",
        english:
      ...
      {
        verse_number: 10,
        original: "Ἀπῆλθον οὖν πάλιν πρὸς αὑτοὺς οἱ μαθηταί",
        english: "Then the disciples returned to their homes",
      },
      {
        verse_number: 11,
        original:
      ...
      {
        verse_number: 28,
        original: "Ἀπεκρίθη Θωμᾶς καὶ εἶπεν αὐτῷ Ὁ Κύριός μου καὶ ὁ Θεός μου",
