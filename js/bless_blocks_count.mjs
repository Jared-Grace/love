export function bless_blocks_count() {
  "How many blocks are actually built into the world.";
  "Two, and two is the smallest number that makes the game's own idea visible. A rung is";
  "earned once and spent anywhere, but spending it still costs a journey - and with one";
  "block there is nowhere to go. The player finishes it, is handed the reach to bless a";
  ...
  "room to grow rather than a promise broken.";
  let count = 2;
  return count;
}
