...
export function js_code_getter_number(code, f_name) {
  ...
  "A body that hands something back in more than one place is not a getter at all, and is refused before anything is read out of it. Why that had to be asked, and what counts as a return, is said where the question itself lives.";
  ...
  let one_return_only = js_code_body_one_return_only_is(body);
