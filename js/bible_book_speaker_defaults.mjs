export function bible_book_speaker_defaults() {
  ...
  let books = [
    { code: "GEN", speaker: "narrator", kind: "narrative" },
    { code: "EXO", speaker: "narrator", kind: "narrative" },
    { code: "LEV", speaker: "narrator", kind: "narrative" },
    { code: "NUM", speaker: "narrator", kind: "narrative" },
    { code: "DEU", speaker: "Moses", kind: "address" },
    { code: "JOS", speaker: "narrator", kind: "narrative" },
    { code: "JDG", speaker: "narrator", kind: "narrative" },
    { code: "RUT", speaker: "narrator", kind: "narrative" },
    { code: "1SA", speaker: "narrator", kind: "narrative" },
    { code: "2SA", speaker: "narrator", kind: "narrative" },
    { code: "1KI", speaker: "narrator", kind: "narrative" },
    { code: "2KI", speaker: "narrator", kind: "narrative" },
    { code: "1CH", speaker: "narrator", kind: "narrative" },
    { code: "2CH", speaker: "narrator", kind: "narrative" },
    { code: "EZR", speaker: "narrator", kind: "narrative" },
    { code: "NEH", speaker: "narrator", kind: "narrative" },
    { code: "EST", speaker: "narrator", kind: "narrative" },
    { code: "JOB", speaker: "narrator", kind: "narrative" },
    { code: "PSA", speaker: "the psalmist", kind: "song" },
    { code: "PRO", speaker: "the teacher", kind: "sayings" },
    { code: "ECC", speaker: "the Preacher", kind: "sayings" },
    { code: "SNG", speaker: "unmarked", kind: "alternating" },
    { code: "ISA", speaker: "Isaiah", kind: "prophecy" },
    { code: "JER", speaker: "Jeremiah", kind: "prophecy" },
    { code: "LAM", speaker: "the lamenter", kind: "song" },
    { code: "EZK", speaker: "Ezekiel", kind: "prophecy" },
    { code: "DAN", speaker: "narrator", kind: "narrative" },
    { code: "HOS", speaker: "Hosea", kind: "prophecy" },
    { code: "JOL", speaker: "Joel", kind: "prophecy" },
    { code: "AMO", speaker: "Amos", kind: "prophecy" },
    { code: "OBA", speaker: "Obadiah", kind: "prophecy" },
    { code: "JON", speaker: "narrator", kind: "narrative" },
    { code: "MIC", speaker: "Micah", kind: "prophecy" },
    { code: "NAM", speaker: "Nahum", kind: "prophecy" },
    { code: "HAB", speaker: "Habakkuk", kind: "prophecy" },
    { code: "ZEP", speaker: "Zephaniah", kind: "prophecy" },
    { code: "HAG", speaker: "Haggai", kind: "prophecy" },
    { code: "ZEC", speaker: "Zechariah", kind: "prophecy" },
    { code: "MAL", speaker: "Malachi", kind: "prophecy" },
    { code: "MAT", speaker: "narrator", kind: "narrative" },
    { code: "MRK", speaker: "narrator", kind: "narrative" },
    { code: "LUK", speaker: "narrator", kind: "narrative" },
    { code: "JHN", speaker: "narrator", kind: "narrative" },
    { code: "ACT", speaker: "narrator", kind: "narrative" },
    { code: "ROM", speaker: "Paul", kind: "letter" },
    { code: "1CO", speaker: "Paul", kind: "letter" },
    { code: "2CO", speaker: "Paul", kind: "letter" },
    { code: "GAL", speaker: "Paul", kind: "letter" },
    { code: "EPH", speaker: "Paul", kind: "letter" },
    { code: "PHP", speaker: "Paul", kind: "letter" },
    { code: "COL", speaker: "Paul", kind: "letter" },
    { code: "1TH", speaker: "Paul", kind: "letter" },
    { code: "2TH", speaker: "Paul", kind: "letter" },
    { code: "1TI", speaker: "Paul", kind: "letter" },
    { code: "2TI", speaker: "Paul", kind: "letter" },
    { code: "TIT", speaker: "Paul", kind: "letter" },
    { code: "PHM", speaker: "Paul", kind: "letter" },
    { code: "HEB", speaker: "the writer to the Hebrews", kind: "letter" },
    { code: "JAS", speaker: "James", kind: "letter" },
    { code: "1PE", speaker: "Peter", kind: "letter" },
    { code: "2PE", speaker: "Peter", kind: "letter" },
    { code: "1JN", speaker: "John", kind: "letter" },
    { code: "2JN", speaker: "John", kind: "letter" },
    { code: "3JN", speaker: "John", kind: "letter" },
    { code: "JUD", speaker: "Jude", kind: "letter" },
    { code: "REV", speaker: "John", kind: "vision" },
  ];
  return books;
}
