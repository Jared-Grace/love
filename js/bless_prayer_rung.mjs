...
export function bless_prayer_rung(rung) {
  ...
  ("reached - 'God bless this person', and then 'God bless this person and everyone in");
  ("their neighborhood', and one day 'and everyone in their country'.");
  ...
  ("it is theirs.");
  ("The lowest rung says nothing more, and that is not a missing clause. 'God bless this");
  ("person and everyone in their person' is nonsense, and the plain prayer is the one the");
  ("whole ladder is built out of.");
