...
export async function claude_bash_labels_ranked(days) {
  ...
  ("A count only means something beside the window it was taken over, so the window is asked for rather than assumed - see `",
    fn_name("claude_bash_commands"),
    "` for what an unwindowed count gets wrong.");
