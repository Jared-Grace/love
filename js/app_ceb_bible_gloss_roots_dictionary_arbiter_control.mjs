import { app_ceb_bible_gloss_roots_dictionary_arbiter_control_entry_read } from "./app_ceb_bible_gloss_roots_dictionary_arbiter_control_entry_read.mjs";
...
export async function app_ceb_bible_gloss_roots_dictionary_arbiter_control() {
  ...
  let said = {};
  let entry_read =
    app_ceb_bible_gloss_roots_dictionary_arbiter_control_entry_read(
      word_key,
      said,
    );
