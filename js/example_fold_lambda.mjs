...
export function example_fold_lambda(x_name) {
  `Adapt ${fn_name("js_fold_all")} (two ASTs) to the examples-gate's one-file transform shape: bind pure fn x by name`;
  `(read its real repo AST live) and return a lambda over F's AST. On refusal ${fn_name("js_fold_all")} returns null`;
