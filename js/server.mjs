...
import { server_static_options } from "./server_static_options.mjs";
import { server_static_resolved } from "./server_static_resolved.mjs";
...
export async function server() {
  ...
  let static_options = server_static_options();
  let v = await server_static_resolved(
    express,
    module_repos_resolve,
    import.meta,
    static_options,
  );
  ...
  let v_public = await server_static_resolved(
    express,
    module_public_resolve,
    import.meta,
    static_options,
  );
  ...
  let v_dev = await server_static_resolved(
    express,
    module_web_dev_resolve,
    import.meta,
    static_options,
  );
  ...
  let v_latest = await server_static_resolved(
    express,
    module_web_latest_resolve,
    import.meta,
    static_options,
  );
