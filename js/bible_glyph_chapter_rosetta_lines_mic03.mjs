export function bible_glyph_chapter_rosetta_lines_mic03() {
  ...
  let chapter = {
    ...
    verses: [
      ...
      },
      {
        verse_number: 2,
        original:
          "שֹׂ֥נְאֵי ט֖וֹב וְאֹ֣הֲבֵי רָעָה גֹּזְלֵ֤י עוֹרָם֙ מֵֽעֲלֵיהֶ֔ם וּשְׁאֵרָ֖ם מֵעַ֥ל עַצְמוֹתָֽם׃",
        english:
      ...
      {
        verse_number: 10,
        original: "בֹּנֶ֥ה צִיּ֖וֹן בְּדָמִ֑ים וִירוּשָׁלִַ֖ם בְּעַוְלָֽה׃",
        english: "who build Zion with bloodshed and Jerusalem with iniquity",
      },
      {
        verse_number: 11,
        original:
