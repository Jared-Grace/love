...
export async function scripts_temp_stale_names(days_text) {
  ...
  ("The count of days arrives as text and is turned into a number here, because the only caller that matters is a command line and a command line has nothing but words. Taking a number and letting the comparison coerce would work by accident and would read as though a number had been passed.");
  ...
  let days = number_from_text(days_text);
