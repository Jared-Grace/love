...
export function bible_songs_outside_psalter() {
  ...
  "★ THE TWO SONGS THAT LOOK LIKE PSALMS ARE NOT THE SAME WORDS, AND THAT WAS MEASURED RATHER THAN ASSUMED. Second Samuel twenty-two is Psalm eighteen, and First Chronicles sixteen verses eight to thirty-six is stitched from Psalms one hundred and five, ninety-six and one hundred and six - but read side by side in this folder they differ line by line. Psalm eighteen opens I love you LORD my strength and Second Samuel twenty-two has no such line, so the numbering runs one apart from there on; where the psalm has the cords of death the narrative has the waves of death; where the psalm has and I am saved the narrative has so shall I be saved; and the narrative adds my savior you save me from violence, which the psalm does not have. First Chronicles sixteen verse eight says Oh give thanks and make what he has done known where Psalm one hundred and five verse one says Give thanks and make his doings known. So one recording cannot stand at two addresses. Second Samuel twenty-two is therefore an entry here, on its own warrant; First Chronicles sixteen is not, because no verse there calls it a song, and it went to the companion list for the same reason Lamentations did.";
  ("The passages the church has sung for centuries without the text saying so are deliberately absent: Hannah, who prayed; Jonah, who prayed; Mary, who said; Zechariah, who prophesied; Simeon; Daniel; the psalm of thanks of First Chronicles sixteen, which David ordained rather than sang; Lamentations, whose only use of the word is the poet complaining he has become their song; and the acclamations of Revelation four, seven, eleven, twelve and nineteen, every one of which says saying rather than singing. Those are gathered in ",
    fn_name("bible_canticles_outside_psalter"),
    " instead. Both lists are to be recorded, so the split is not about what gets sung; it is about what can be checked, since an entry here can be held against the verse warranting it and an entry there cannot, and merging them would make a choice look like a finding.");
  ("Three hundred and twenty-five verses in all, against the Psalter's two thousand four hundred and sixty-one. The Psalms are the work; this is the remainder.");
  let songs = [
    {
      chapter_code: "EXO15",
      verse_first: 1,
    ...
    },
    {
      ...
      verse_first: 1,
      verse_last: 51,
      name: "Song of David, the near twin of Psalm eighteen",
      warrant:
        "2SA22:1 - David spoke to the LORD the words of this song in the day that the LORD delivered him out of the hand of all his enemies",
    },
    {
      chapter_code: "ISA26",
      verse_first: 1,
