import { app_g_day_follower_stranger_pass } from "./app_g_day_follower_stranger_pass.mjs";
...
export function app_g_day_followers_step(g) {
  ...
  "a stranger the player has just traded places with is left standing in the tile the front of the line is walking into, so each member trades with them in turn on the way past and the stranger comes out behind the whole line";
