...
export async function app_ceb_bible_words_written_lowered_set() {
  ...
  ("Two of the four ask it as their opening lines and those call this. The other two ask it further down, after they have read the dictionary or cut a word up, and they still spell the two lines out - not because they want anything different, but because the only transform that can make this swap works on the opening of a function and their copy is not at the opening of anything.");
