...
export function song_god_our_savior_versions() {
  "The passages this song quotes from some translation other than the page's usual one, each against the bible it is read out of and the name that bible is shown under.";
