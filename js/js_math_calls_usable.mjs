import { js_math_calls } from "./js_math_calls.mjs";
...
export function js_math_calls_usable(ast) {
  "The Math methods that may be rewritten in this one file: every pairing the repo keeps, less the two kinds that would turn a working file into a broken one.";
