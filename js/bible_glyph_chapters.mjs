...
export function bible_glyph_chapters() {
  ...
  "Five chapters today, and the list is here rather than the chapters being found by name so that nothing has to guess what exists. A reader asking what this Bible contains gets an answer instead of a search.";
  ...
  let chapters = [first, second, third, fourth, fifth];
  return chapters;
}
