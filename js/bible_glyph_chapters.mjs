...
export function bible_glyph_chapters() {
  ...
  "One chapter today, and the list is here rather than the chapter being found by name so that nothing has to guess what exists. A reader asking what this Bible contains gets an answer instead of a search.";
  ...
  let chapter = bible_glyph_chapter_1jn04();
