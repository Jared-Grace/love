...
export function bible_dream_corridor_tolerance_squared() {
  ...
  "It comes back squared, because every gap it will be compared against arrives squared from bible_dream_point_gap_squared, which leaves the root off on purpose.";
  let half = bible_dream_corridor_width() / 2;
  return half * half;
}
