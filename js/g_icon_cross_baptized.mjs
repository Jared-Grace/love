...
export function g_icon_cross_baptized(div_map, coordinates) {
  "place the BLUE baptized cross (believes + baptized) on a tile — the #day_unbelievers demo marks a person with this the instant the player reaches them, skipping the dialogue (blue = converted AND baptized in one step)";
