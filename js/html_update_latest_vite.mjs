...
import { html_code_script_src_js } from "./html_code_script_src_js.mjs";
import { list_join_newline } from "./list_join_newline.mjs";
import { js_code_dot_same } from "./js_code_dot_same.mjs";
...
export async function html_update_latest_vite(search) {
  ...
  let code3 = js_code_dot_same(fn_name("app_shared_context_initialize"));
