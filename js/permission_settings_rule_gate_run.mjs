import { permission_rules_settings_write } from "./permission_rules_settings_write.mjs";
import { permission_rules } from "./permission_rules.mjs";
import { each } from "./each.mjs";
import { greater_than } from "./greater_than.mjs";
import { text_combine_multiple } from "./text_combine_multiple.mjs";
import { log_console } from "./log_console.mjs";
export async function permission_settings_rule_gate_run() {
  ...
  let offenders = await permission_rules_settings_write();
