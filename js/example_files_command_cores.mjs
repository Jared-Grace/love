...
import { js_span_call_existing_inner_dir } from "./js_span_call_existing_inner_dir.mjs";
export function example_files_command_cores() {
  ...
  let cores = [
    ...
    {
      name: fn_name("function_span_call_existing_inner"),
      core: js_span_call_existing_inner_dir,
    },
  ];
  return cores;
}
