export function bible_glyph_chapter_rosetta_lines_1jn02() {
  ...
  let chapter = {
    ...
    verses: [
      ...
      },
      {
        ...
        english: "Whoever claims to abide in Him must walk as Jesus walked",
      },
      {
        verse_number: 7,
        original:
      ...
      {
        verse_number: 20,
        original: "Καὶ ὑμεῖς χρῖσμα ἔχετε ἀπὸ τοῦ Ἁγίου καὶ οἴδατε πάντες",
        english:
      ...
      {
        verse_number: 26,
        original: "Ταῦτα ἔγραψα ὑμῖν περὶ τῶν πλανώντων ὑμᾶς",
        english:
