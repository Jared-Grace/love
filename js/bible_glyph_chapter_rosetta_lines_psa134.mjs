export function bible_glyph_chapter_rosetta_lines_psa134() {
    ...
    verses: [
      {
        ...
        english:
          "A song of ascents Come bless the LORD all you servants of the LORD who serve in the house of the LORD by night",
      },
      {
        verse_number: 2,
        original: "שְׂאֽוּ־ יְדֵכֶ֥ם קֹ֑דֶשׁ וּ֝בָרֲכוּ אֶת־ יְהוָֽה׃",
        english: "Lift up your hands to the sanctuary and bless the LORD",
      },
      {
        verse_number: 3,
        original:
        ...
        english:
          "bless you May the LORD from Zion the Maker of heaven and earth",
      },
    ],
  };
  return chapter;
