...
import { memory_index_hooks_compress_line_walk } from "./memory_index_hooks_compress_line_walk.mjs";
...
export function memory_index_hooks_compress_line(lines) {
  ...
  let r3 = memory_index_hooks_compress_line_walk(r2, lines, link_open, dash);
