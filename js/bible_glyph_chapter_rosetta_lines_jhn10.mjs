export function bible_glyph_chapter_rosetta_lines_jhn10() {
  ...
  let chapter = {
    ...
    verses: [
      ...
      {
        verse_number: 2,
        original: "ὁ δὲ εἰσερχόμενος διὰ τῆς θύρας ποιμήν ἐστιν τῶν προβάτων",
        english:
      ...
      {
        verse_number: 13,
        original: "ὅτι μισθωτός ἐστιν καὶ οὐ μέλει αὐτῷ περὶ τῶν προβάτων",
        english:
      ...
      },
      {
        ...
        english: "I am the good shepherd I know My sheep and My sheep know Me",
      },
      {
        verse_number: 15,
        original:
      ...
      {
        verse_number: 22,
        original: "Ἐγένετο τότε τὰ ἐνκαίνια ἐν τοῖς Ἱεροσολύμοις χειμὼν ἦν",
        english:
          "At that time the Feast of Dedication took place in Jerusalem It was winter",
      },
      {
        verse_number: 23,
        original: "καὶ περιεπάτει ὁ Ἰησοῦς ἐν τῷ ἱερῷ ἐν τῇ στοᾷ τοῦ Σολομῶνος",
        english:
      ...
      },
      {
        ...
        english: "But because you are not My sheep you refuse to believe",
      },
      {
        verse_number: 27,
        original:
          "τὰ πρόβατα τὰ ἐμὰ τῆς φωνῆς μου ἀκούουσιν κἀγὼ γινώσκω αὐτά καὶ ἀκολουθοῦσίν μοι",
        english: "My sheep listen to My voice I know them and they follow Me",
      },
      {
        verse_number: 28,
        original:
      ...
      {
        verse_number: 37,
        original: "Εἰ οὐ ποιῶ τὰ ἔργα τοῦ Πατρός μου μὴ πιστεύετέ μοι",
        english:
      ...
      {
        verse_number: 42,
        original: "καὶ πολλοὶ ἐπίστευσαν εἰς αὐτὸν ἐκεῖ",
        english: "And many in that place believed in Jesus",
      },
    ],
  };
  return chapter;
