...
export function app_code_lesson_expression_string_concat_above(root, context) {
  ...
  let r = app_code_lesson_expression_string_concat_above_right_line(root, context);
