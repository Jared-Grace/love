...
export async function gloss_chapters_roots_claimed_entries_generic(
  ...
  "How many chapters were walked comes back, and beside it how many entries were met - counting every entry the store holds and not only the ones that carry an explanation. That second number is the one thing a caller cannot work out for itself afterwards, because the entries without an explanation are never handed over, and a reading wanting to say what share of the store explains anything needs the whole of it as the denominator. Everything else about the entries, each reading counts for itself.";
