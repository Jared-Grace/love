...
export function property_list_get_end_1(object, property_name) {
  ...
  ("and the one before it is what encloses it. The dozen files that did so now ask");
  (fn_name("js_visit_above"),
    ", which is that one reading under a name saying what it means.");
