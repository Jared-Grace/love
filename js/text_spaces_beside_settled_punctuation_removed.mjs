export function text_spaces_beside_settled_punctuation_removed(text) {
  ...
  "The one exception is a space between a sentence mark and a curly closing quote. What stands to the left of the space settles it: no language puts a comma or a full stop at the start of what follows, so the quotation mark can only be closing the speech that comma ended.";
