...
export function bless_hash_building_first_completed() {
  ...
  ("One prayer from finished rather than finished, because the FINISHING is what is being looked at. A street opened with the house already gold shows the result and never the thing that produces it.");
  ("The player is left standing on the household rung, which is not a favour but the truth of the record handed over: two whole families have been completed, and completing a family is exactly what earns that rung. So the last prayer reaches the whole of the family left, which is how a building is actually finished in play.");
  let word = "building_first_completed";
  return word;
}
