...
export async function lyric_video_psalms_documents_time(version) {
  ...
  ("$plain version");
  ("Listens to every psalm sung on this machine that has a timing document, writes the times into the ones nobody has timed by hand, and hands back how much of each psalm was heard.");
  ...
  ("The whole hearing of each chapter is already kept in the findings folder by the step itself, so what comes back here is only enough to see the shape of the run. The detail is a file name away and does not need carrying through a terminal.");
