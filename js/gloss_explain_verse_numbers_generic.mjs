...
export function gloss_explain_verse_numbers_generic(
  ...
  "$plain markers";
  "$plain distances";
  "the markers are the words the explanation's own language uses for verse, the joiner is its word for and, and the distances are its words for counting backwards from here. All of them are words from a language and none names anything that runs.";
