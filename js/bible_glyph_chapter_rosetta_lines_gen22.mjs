export function bible_glyph_chapter_rosetta_lines_gen22() {
  ...
  let chapter = {
    ...
    verses: [
      ...
      },
      {
        ...
        english: "Uz the firstborn his brother Buz Kemuel the father of Aram",
      },
      {
        verse_number: 22,
        original:
          "וְאֶת־ כֶּ֣שֶׂד וְאֶת־ חֲז֔וֹ וְאֶת־ פִּלְדָּ֖שׁ וְאֶת־ יִדְלָ֑ף וְאֵ֖ת בְּתוּאֵֽל׃",
        english: "Chesed Hazo Pildash Jidlaph and Bethuel",
      },
      {
        verse_number: 23,
        original:
