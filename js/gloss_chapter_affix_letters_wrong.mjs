...
import { gloss_entries_affix_letters_wrong } from "./gloss_entries_affix_letters_wrong.mjs";
export async function gloss_chapter_affix_letters_wrong(
  chapter_code,
  fn,
  known,
) {
  "Every explanation in one gloss chapter that quotes letters for a piece of its word which the dictionary gives no piece of that kind holding.";
  "$plain chapter_code";
  ...
  function found_of(entries) {
    let found = gloss_entries_affix_letters_wrong(entries, known);
    return found;
  }
