export function bible_glyph_chapter_rosetta_lines_ezk01() {
  ...
  let chapter = {
    ...
    verses: [
      ...
      },
      {
        ...
        english: "but each had four faces and four wings",
      },
      {
        verse_number: 7,
        original:
      ...
      },
      {
        verse_number: 8,
        original:
          "וְיָדוֹ אָדָ֗ם מִתַּ֙חַת֙ כַּנְפֵיהֶ֔ם עַ֖ל אַרְבַּ֣עַת רִבְעֵיהֶ֑ם וּפְנֵיהֶ֥ם וְכַנְפֵיהֶ֖ם לְאַרְבַּעְתָּֽם׃",
        english:
      ...
      {
        verse_number: 14,
        original: "וְהַחַיּ֖וֹת רָצ֣וֹא וָשׁ֑וֹב כְּמַרְאֵ֖ה הַבָּזָֽק׃",
        english:
