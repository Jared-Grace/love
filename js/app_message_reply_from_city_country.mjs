...
export function app_message_reply_from_city_country() {
  "Answers a message whose writer says where they are from - `i am from lahore pakistan`, `i am pastor john from kenya` - with the fixed sentence giving our own location back.";
