...
export function app_code_lesson_expression_exponent() {
  ...
  "The two worked examples are 2 ** 3 and 5 ** 4, chosen rather than drawn, and they move both numbers between them - the base and how many of it - so a learner reading only the examples sees that both are free. The drawn questions take the two bases those did not use.";
  "5 ** 4 comes to six hundred and twenty five and that does not matter: nothing on this lesson ever asks what the line comes to, only what it is written out as. The one thing the larger exponent buys is a fourth 5 in the written-out form, which is a length nothing drawn ever reaches.";
