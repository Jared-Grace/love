export function app_en_learn_bible_gloss_urdu_superseded_explains() {
  "Every wording that was once the settled explanation of an English word in the store that teaches English to an Urdu reader, and has since been replaced by a better one.";
