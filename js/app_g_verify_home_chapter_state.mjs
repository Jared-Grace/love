...
import { storage_session_specify_get } from "./storage_session_specify_get.mjs";
...
export function app_g_verify_home_chapter_state() {
  ...
  let chapter_code = opened || storage_local_specify_get_json(v) || "1JN01";
  ...
  let selected_key = storage_session_specify_get(storage_key);
