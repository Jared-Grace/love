...
export function app_code_highlight_color_second() {
  ...
  ("Amber against the deep blue, and taken from the four colours this app already tells one number from another with rather than chosen here. Blue and amber is the pair that stays apart for a reader who cannot tell red from green, and it is about the furthest apart pair for everybody else. Green and red were the other deep colours to hand and both were wrong: this app says done in green and says wrong in red, in those very colours, a screen or two away.");
