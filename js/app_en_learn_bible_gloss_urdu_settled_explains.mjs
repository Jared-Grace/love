...
export function app_en_learn_bible_gloss_urdu_settled_explains() {
  ...
  "There are seven tables behind this and they are kept apart because their reasons are different. One holds the small closed classes - the articles, the joining words, the prepositions, the pronouns - where what the word does in a sentence is the whole of what there is to say and no dictionary work stands behind any of it. One holds the ordinary nouns, where the whole of the entry is the Urdu word for the thing and every line of it is dictionary work. The third holds the names, where the entry is neither of those: it is who the person is, which is read off the passages themselves rather than out of a dictionary, and it goes stale for a different reason than either of the others.";
  ...
  "They are joined here rather than in any one of them so that the pass which writes settled wordings over shared labels asks one question and not seven, and so that a further kind of word is added by writing another table and one line here.";
