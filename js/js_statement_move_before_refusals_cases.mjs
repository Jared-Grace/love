...
export function js_statement_move_before_refusals_cases() {
  "Written-out modules, each beside the word on the line that would be moved, the word on the line it would come to stand above, and every reason the move is refused.";
  ...
  "Every module here hands its function out, because the reading finds the function by looking along the module's own top line for what it exports. A body written without that word is not a smaller case, it is a module the reading stops on.";
