export function song_image_review_couplets() {
  ...
  let couplets = [
    ...
    {
      n: 24,
      note: "You asked what was wrong with 114. It had no tomb in it - only a glowing boulder - so the rays were not coming out of an entrance, which you had asked for three times. Here they come out of the white inside the mouth. The stone is still smaller than the entrance, which you have also asked for twice.",
    },
    {
      n: 26,
