...
export function app_g_scripture(parent, reference, verse_text) {
  "render displayed Scripture inline: reference (green) + 📖 (the written-word marker) + glowing gold verse (app_g_scripture_verse); DRY for gospel-share passage buttons";
