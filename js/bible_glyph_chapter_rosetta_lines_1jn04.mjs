export function bible_glyph_chapter_rosetta_lines_1jn04() {
  ...
  let chapter = {
    ...
    verses: [
      ...
      },
      {
        ...
        english:
          "They of the world are That is why perspective from the world’s they speak and the world them listens to",
      },
      {
        verse_number: 6,
        original:
        ...
        english:
          "We from God are Whoever knows God listens to us whoever not is from God does not listen to us That is how we know the Spirit of truth and the spirit of deception",
      },
      {
        verse_number: 7,
        original:
        ...
        english:
          "Beloved let us love one another because love from God comes Everyone who loves of God has been born and knows God",
      },
      {
        verse_number: 8,
        original: "ὁ μὴ ἀγαπῶν οὐκ ἔγνω τὸν Θεόν ὅτι ὁ Θεὸς ἀγάπη ἐστίν",
        english: "Whoever does not love does not know God because God love is",
      },
      {
        verse_number: 9,
        original:
        ...
        english:
          "This is how was revealed love God’s among us Son His one and only sent God into the world so that we might live through Him",
      },
      {
        verse_number: 10,
        original:
      ...
      },
      {
        ...
        english: "Beloved if so God loved us also we ought one another to love",
      },
      {
        verse_number: 12,
        original:
      ...
      },
      {
        ...
        english:
          "By this we know that in Him we remain and He in us of Spirit His He has given us",
      },
      {
        verse_number: 14,
        original:
      ...
      },
      {
        ...
        english:
          "anyone If confesses that Jesus is the Son of God God in him abides and he in God",
      },
      {
        verse_number: 16,
        original:
        ...
        english:
          "And we have come to know and believe the love that has God for us God love is whoever abides in love in God abides and God in him",
      },
      {
        verse_number: 17,
        original:
      ...
      },
      {
        ...
        english:
          "And this commandment we have from Him Whoever loves God must love as well brother his",
      },
    ],
  };
  return chapter;
