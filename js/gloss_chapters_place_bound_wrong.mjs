...
export async function gloss_chapters_place_bound_wrong(
  ...
  "How many explanations across one whole gloss store say the word wears a capital because a verse begins where it stands, how many of those sit on a word carrying no capital at all, and which words and wordings those were.";
