export function word_pictures_drawn_known() {
  "Which attempts exist for each taught word, as a plain table written out by word_pictures_drawn_known_write and never edited by hand.";
