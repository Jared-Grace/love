import { app_shared_money_sections } from "./app_shared_money_sections.mjs";
...
export function app_shared_money_body(container) {
  ...
  let sections = app_shared_money_sections();
