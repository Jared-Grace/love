...
export function bible_glyph_characters() {
  ...
  "AND IT WAS COSTING PICTURES, which is the part that can be counted. A line holding both words had to stand both of its marks down, because a reader meeting the same picture twice cannot tell which is which - a hundred and forty one marks across the written chapters were blank for that reason alone and no other. The fourteenth verse of the fourth of Ruth is the clearest of them: the neighbours bless God for a redeemer and pray the child will be famous, and it was the emptiest line on the page.";
