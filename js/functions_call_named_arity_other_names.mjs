...
export async function functions_call_named_arity_other_names(
  ...
  ("The files among these holding a call to f_name that hands over some number of things other than this one, each named beside the numbers it was found handing over.");
  ...
  for (let name of f_names) {
    ...
    let sizes = js_call_named_arity_other_nodes(ast, f_name, size);
