...
export async function lyric_video_documents_gate_run() {
  ...
  async function document_faults(path_document) {
  ...
  let by_document = await list_map_unordered_async(paths_json, document_faults);
  let faults_all = list_concat_multiple(by_document);
