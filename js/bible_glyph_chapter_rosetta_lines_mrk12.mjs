export function bible_glyph_chapter_rosetta_lines_mrk12() {
  ...
  let chapter = {
    ...
    verses: [
      ...
      {
        verse_number: 3,
        original: "καὶ λαβόντες αὐτὸν ἔδειραν καὶ ἀπέστειλαν κενόν",
        english:
      ...
      },
      {
        ...
        english: "This is from the Lord and it is marvelous in our eyes",
      },
      {
        verse_number: 12,
        original:
      ...
      {
        verse_number: 27,
        original: "οὐκ ἔστιν Θεὸς νεκρῶν ἀλλὰ ζώντων πολὺ πλανᾶσθε",
        english:
