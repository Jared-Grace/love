...
import { ebible_offline_chapters_all_upload } from "./ebible_offline_chapters_all_upload.mjs";
export async function ebible_offline_version_upload(bible_folder) {
  ...
  await ebible_bible_folder_commercial_assert(bible_folder2);
  await ebible_chapter_codes_upload(bible_folder);
  await ebible_offline_chapters_all_upload(bible_folder);
}
