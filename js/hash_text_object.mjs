...
export function hash_text_object(hash_url) {
  "The hash end of an address, given as text, read apart into the words it names and what it says for each; text with no hash mark names nothing.";
  ...
  "Taking the text rather than reading the page is what lets a caller outside the page - a browser test holding the address it sees - read it the same way the page does.";
  function lambda3(oa) {
