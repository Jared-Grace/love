...
export function song_image_couplets_versions() {
  ...
  "IT STARTS AS TWO ENTRIES BECAUSE TWO IS WHAT THIS SONG WAS ALREADY BEING SHOWN. The page used to keep one list keyed by the passage alone, so a passage decided for the other song was silently decided for this one as well; sixteen passages are sung by both. Two of those sixteen had an entry, and writing exactly those two down here leaves every reader looking at what they were looking at yesterday. The other fourteen were never in that list and so were already coming out of the page's usual bible.";
