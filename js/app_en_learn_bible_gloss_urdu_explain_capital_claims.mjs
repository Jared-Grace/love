export function app_en_learn_bible_gloss_urdu_explain_capital_claims() {
  ...
  "Each is spelled with no vowel marks - the explanation has its marks taken off before it is compared - so a wording written with a zer is the same claim as one written without.";
  let claims = [
    "پہلا حرف بڑا ہے",
    "بڑے حرف سے لکھا جاتا ہے",
    "بڑے حرف سے لکھا ہے",
  ];
  return claims;
}
