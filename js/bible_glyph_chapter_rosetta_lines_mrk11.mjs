export function bible_glyph_chapter_rosetta_lines_mrk11() {
  ...
  let chapter = {
    ...
    verses: [
      ...
      {
        verse_number: 6,
        original: "Οἱ δὲ εἶπαν αὐτοῖς καθὼς εἶπεν ὁ Ἰησοῦς καὶ ἀφῆκαν αὐτούς",
        english:
      ...
      {
        verse_number: 12,
        original: "Καὶ τῇ ἐπαύριον ἐξελθόντων αὐτῶν ἀπὸ Βηθανίας ἐπείνασεν",
        english: "The next day when they had left Bethany Jesus was hungry",
      },
      {
        verse_number: 13,
        original:
      ...
      {
        verse_number: 16,
        original: "καὶ οὐκ ἤφιεν ἵνα τις διενέγκῃ σκεῦος διὰ τοῦ ἱεροῦ",
        english:
      ...
      {
        verse_number: 19,
        original: "Καὶ ὅταν ὀψὲ ἐγένετο ἐξεπορεύοντο ἔξω τῆς πόλεως",
        english:
      ...
      },
      {
        ...
        english: "Have faith in God Jesus said to them",
      },
      {
        verse_number: 23,
        original:
      ...
      },
      {
        ...
        english: "John’s baptism was it from heaven or from men Answer Me",
      },
      {
        verse_number: 31,
        original:
