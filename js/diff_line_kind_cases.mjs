export function diff_line_kind_cases() {
  ...
  "THE RECORD ENTRIES ARE THE POINT OF THE CORPUS. Two of them are here and both would have passed before - one closing at a comma because another entry follows, one closing at its own value because it is the last. Between them they hold the fix in place, which is that a paragraph is known by how it ends and not by how it begins.";
