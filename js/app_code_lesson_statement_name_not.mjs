...
export function app_code_lesson_statement_name_not() {
  ...
  ("the opposite of a name: let a = true; console.log(!a); writes out false");
  ...
  function program_of(value) {
    "the two lines that give a true or false value the name and write out its opposite";
    let held = js_code_let_statement(name, value);
    let code = list_join_newline([held, logged]);
    return code;
  }
  ...
  function above(root, context) {
    ...
    app_code_code_lines_writes_out(box_name, [held, logged], value_false);
  }
