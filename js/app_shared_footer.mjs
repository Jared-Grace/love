...
export function app_shared_footer(parent) {
  ...
  "The two stand side by side in one row rather than stacked, because the foot stays in sight the whole time and every line it takes is a line of the reading lost for as long as the app is open.";
