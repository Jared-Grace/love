...
import { bible_glyph_chapters_verses_ordinary_space_gate_run } from "./bible_glyph_chapters_verses_ordinary_space_gate_run.mjs";
...
export function qa_gates() {
  ...
  let gates = [
    ...
    bible_glyph_chapters_verses_ordinary_space_gate_run,
