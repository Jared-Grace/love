...
export function js_rewrite_targets(ast) {
  ...
  ("Which functions this tree has written out again by name - read from the first argument of every call it makes to a rewriting command, rather than from every name it happens to spell.");
