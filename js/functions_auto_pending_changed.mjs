...
export async function functions_auto_pending_changed() {
  ...
  "The repo-wide form of this question sweeps seven thousand functions and takes a quarter of an hour, because every answer runs a whole pipeline rather than reading a file. This one asks it of the handful of files with an uncommitted edit in them, which is seconds - and those are the only files where the answer can be anybody's to act on, since a function nobody has touched has been in whatever state it is in since long before today.";
