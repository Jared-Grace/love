...
export function g_clock_sky_phase_check() {
  ...
  assert(greater_than(g_clock_sky_phase(18.5), 9.5), "18:30 → past 9.5 (fast dark after sunset)");
  assert(greater_than(g_clock_sky_phase(19), 9.9), "19:00 → past 9.9 (~90% dark by 7 PM)");
  assert(greater_than(g_clock_sky_phase(21), 9.9), "21:00 → still >9.9 (deep-night plateau, not linear 9.5)");
  assert(less_than(g_clock_sky_phase(3), 4.1), "3:00 → still <4.1 (deep-dark pre-dawn plateau, not linear 4.5)");
