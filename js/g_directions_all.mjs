export function g_directions_all() {
  ...
  "There are eight of them. The game itself walks on four, which is what g_directions returns, so the two lists differ on purpose: this one says what the art HOLDS and that one says what the game USES.";
