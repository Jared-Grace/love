export function bible_glyph_chapter_rosetta_lines_gen41() {
  ...
  let chapter = {
    ...
    verses: [
      ...
      },
      {
        verse_number: 30,
        original:
          "וְ֠קָמוּ שֶׁ֜בַע שְׁנֵ֤י רָעָב֙ אַחֲרֵיהֶ֔ן וְנִשְׁכַּ֥ח כָּל־ הַשָּׂבָ֖ע בְּאֶ֣רֶץ מִצְרָ֑יִם וְכִלָּ֥ה הָרָעָ֖ב אֶת־ הָאָֽרֶץ׃",
        english:
      ...
      },
      {
        ...
        english: "This proposal pleased Pharaoh and all his officials",
      },
      {
        verse_number: 38,
        original:
