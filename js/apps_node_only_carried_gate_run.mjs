...
import { apps_node_only_carried_walked } from "./apps_node_only_carried_walked.mjs";
...
export async function apps_node_only_carried_gate_run() {
  ...
  "HOW MANY CARRIED FUNCTIONS WERE OPENED TRAVELS OUT WITH THE VERDICT. A ratchet finding nothing new says the same word whether every bundle was walked and none had grown, or the walk out from the app entry points reached nothing at all - and this walk is the fragile half, following imports across the whole repo. The offenders are pinned at whatever the record already held and so cannot fall; the count can.";
  arguments_assert(arguments, 0);
  let told = await apps_node_only_carried_walked();
