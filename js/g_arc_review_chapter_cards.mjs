...
export async function g_arc_review_chapter_cards(chapter_code) {
  ...
  "WHO THE PEOPLE ARE IS ASKED ONCE FOR THE WHOLE CHAPTER, and that is the difference between a page and a page that never arrives. Both of the things this needs about a person - what they are called and whether they are a man or a woman - are answered by dealing the entire cast, and dealing the cast counts every sermon that has been written. Asked per person, a chapter of three people read the whole sermon supply six times over; the page died on a phone with three aborted requests and no partial drawing. Asked here it is read twice however many people the chapter holds.";
