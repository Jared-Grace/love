...
export function app_code_colors_placed_by_hue() {
  ...
  ("every colour this app draws, put on the colour wheel and stood in order round it - each one carrying the way it is written, whether it is a dark colour or a light one, and its hue in degrees");
