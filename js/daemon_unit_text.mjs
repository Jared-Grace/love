...
export function daemon_unit_text(f_name) {
  ...
  let start = text_combine_multiple([node_path, " scripts/r.mjs ", f_name]);
  let description = text_combine_multiple(["love ", f_name]);
  ...
  let runtime_max = daemon_runtime_max(f_name);
