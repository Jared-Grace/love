export function bible_glyph_chapter_rosetta_lines_mrk10() {
  ...
  let chapter = {
    ...
    verses: [
      ...
      {
        verse_number: 3,
        original: "Ὁ δὲ ἀποκριθεὶς εἶπεν αὐτοῖς Τί ὑμῖν ἐνετείλατο Μωϋσῆς",
        english: "What did Moses command you He replied",
      },
      {
        verse_number: 4,
        original:
      ...
      {
        verse_number: 6,
        original: "ἀπὸ δὲ ἀρχῆς κτίσεως Ἄρσεν καὶ θῆλυ ἐποίησεν αὐτούς",
        english:
      ...
      {
        verse_number: 9,
        original: "ὃ οὖν ὁ Θεὸς συνέζευξεν ἄνθρωπος μὴ χωριζέτω",
        english: "Therefore what God has joined together let man not separate",
      },
      {
        verse_number: 10,
        original:
      ...
      },
      {
        ...
        english: "Teacher he replied all these I have kept from my youth",
      },
      {
        verse_number: 21,
        original:
      ...
      {
        verse_number: 31,
        original: "πολλοὶ δὲ ἔσονται πρῶτοι ἔσχατοι καὶ οἱ ἔσχατοι πρῶτοι",
        english:
      ...
      {
        verse_number: 36,
        original: "Ὁ δὲ εἶπεν αὐτοῖς Τί θέλετε με ποιήσω ὑμῖν",
        english: "What do you want Me to do for you He inquired",
      },
      {
        verse_number: 37,
        original:
      ...
      {
        verse_number: 44,
        original: "καὶ ὃς ἂν θέλῃ ἐν ὑμῖν εἶναι πρῶτος ἔσται πάντων δοῦλος",
        english: "and whoever wants to be first must be the slave of all",
      },
      {
        verse_number: 45,
        original:
