...
export function app_reply_rules_corpus_show(root, cases) {
  ...
  ("Every worked case run against the reply rules as they stand, each drawn as the exchange it stands for, and each one that has stopped doing what it was written to do saying so in red underneath.");
