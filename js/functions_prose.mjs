import { js_code_prose_backtick_is } from "./js_code_prose_backtick_is.mjs";
import { function_prose_lines_template } from "./function_prose_lines_template.mjs";
...
export async function functions_prose() {
  ...
  async function each_name(f_name) {
    ...
    let backtick_is = js_code_prose_backtick_is(code);
    if (backtick_is) {
      let gapped = function_prose_lines_template(code);
      list_add_multiple(lines, gapped);
    }
