...
export function week_calendar_preview() {
  "preview the weekly availability grid on the sandbox app at #week_calendar: click a 30-minute piece, then another piece in the same day, to select the range between them";
  ...
  function on_ranges(ranges) {
    let text = text_combine_multiple(["Selected ranges: ", list_size(ranges)]);
