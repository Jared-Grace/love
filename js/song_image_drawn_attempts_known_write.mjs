...
export async function song_image_drawn_attempts_known_write() {
  "count what is actually in the picture folders and write song_image_drawn_attempts_known from it, so the table the picker reads says what the disk says";
  ...
  let path = path_join([
    folder_repo_love(),
    "js",
    "song_image_drawn_attempts_known.mjs",
  ]);
