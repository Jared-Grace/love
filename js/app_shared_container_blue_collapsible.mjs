...
export function app_shared_container_blue_collapsible(parent, title_text) {
  ...
  ("this card only holds one line of its own - the title - so the card padding a page of text wants is all pushing the groups inside it down the screen; trimmed top-and-bottom and packed close to its neighbour, a phone shows several more books before scrolling");
