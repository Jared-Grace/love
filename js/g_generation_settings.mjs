...
export function g_generation_settings() {
  ...
  ("That price is COUNTED now, in ",
    ...
    ", and the counting moved this number. It was six against a price of seven - a conversation at the floor bought six turns for seven taps, so the player paid more to get in than they got out. The reason was written down and the number was never checked against it, because the price was prose.");
  ("Eight puts the worst conversation a little over break-even rather than under it, and leaves the usual length untouched. Measured over twenty scheduled plants, days holding four people fell from forty-four to fifteen and days holding two rose from seventy-two to ninety-eight - the variety is still there, and the days that lost people are the ones that were filling up on conversations barely worth walking over for. A plant's headcount did not move at all, because that is bought with arc TURNS and this only says how they may be cut up.");
