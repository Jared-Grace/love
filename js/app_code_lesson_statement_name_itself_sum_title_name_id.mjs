...
export function app_code_lesson_statement_name_itself_sum_title_name_id() {
  ...
  ("the home title: giving a name what it and another name add up to, the eighth Statements lesson, followed by the line that does it");
  ...
  let words = "giving a name what it and another name add up to";
