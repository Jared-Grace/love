import { app_ceb_bible_gloss_write_coverage } from "./app_ceb_bible_gloss_write_coverage.mjs";
import { app_ceb_bible_gloss_write_passage } from "./app_ceb_bible_gloss_write_passage.mjs";
import { list_empty_is } from "./list_empty_is.mjs";
import { list_first } from "./list_first.mjs";
import { list_size } from "./list_size.mjs";
import { objects_merge } from "./objects_merge.mjs";
import { property_get } from "./property_get.mjs";
export async function app_ceb_bible_gloss_write_next(chapter_code) {
  "Everything needed to author the next passage of a Cebuano chapter that has no word explanations yet: its Cebuano wording, its English wording, and each of its words with what a dictionary says it is built from.";
  "$plain chapter_code";
  ...
  let coverage = await app_ceb_bible_gloss_write_coverage(chapter_code);
  ...
  let handed = await app_ceb_bible_gloss_write_passage(chapter_code, verse_key);
  let left = {
