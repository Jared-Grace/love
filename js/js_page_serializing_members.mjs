...
export function js_page_serializing_members() {
  ...
  let t = text_frozen("evaluate");
  let t2 = text_frozen("evaluateHandle");
  let t3 = text_frozen("waitForFunction");
  let t4 = text_frozen("addInitScript");
  let t5 = text_frozen("exposeFunction");
  let t6 = text_frozen("$eval");
  let t7 = text_frozen("$$eval");
  let members = [t, t2, t3, t4, t5, t6, t7];
  return members;
}
