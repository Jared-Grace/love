...
export async function linger_is() {
  ...
  ("the name comes from node rather than the shell because ",
    fn_name("command_line"),
    " refuses shell operators, so there is no $(id -u) to expand");
  ...
  let left = text_trim(text);
  let v = equal(left, "yes");
  return v;
}
