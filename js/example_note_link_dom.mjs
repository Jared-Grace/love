...
`same light note-code look as ${fn_name("example_note_code_dom")}, but clickable, exactly like`;
`the FUNCTION chip (both go through ${fn_name("example_source_link_dom")} + ${fn_name("function_github_url")}).`;
