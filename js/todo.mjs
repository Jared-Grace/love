...
export function todo(description) {
  ...
  "already, which is the whole of what a reader needs from a marker; a parameter";
  "can come back the day a site proves it wants to say more than where it is.";
  error("todo: this part is not built yet");
}
