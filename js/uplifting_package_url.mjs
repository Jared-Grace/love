...
export function uplifting_package_url(bible_folder) {
  "the verse-text packages live in firebase storage now, not hosting, so a package's url is its storage download url (bible/uplifting/<folder>.json in the jared-grace bucket). uplifting_package_get fetches this the same way as before.";
