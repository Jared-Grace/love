...
export function app_music_reference_version(versions, reference) {
  "$plain reference";
  "Which translation one passage of one song is quoted from, as the folder its chapters sit in and the name a reader is shown it under, given that song's own short list of passages it quotes from something unusual.";
  "IT ALWAYS ANSWERS. Every passage on the page is quoted from something, so there is no such thing as a passage with no translation, and handing back nothing for the ordinary case would put the same falling back into every caller that asks. The song's short list of exceptions is asked first and the page's usual translation answers for everything else.";
