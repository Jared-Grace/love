...
export function app_code_lesson_text_line_operator_mix_or_null(text) {
  ...
  ("Two operators is what makes the question exist at all, the same threshold the parentheses are read at and for the same reason. One operator is neither repeated nor mixed with anything.");
