...
import { berean_chapter_paragraphed_text } from "./berean_chapter_paragraphed_text.mjs";
import { clipboard_copy } from "./clipboard_copy.mjs";
export async function berean_chapter_clipboard_copy_numbered(
  book_code,
  chapter_number,
) {
  ...
  let text = await berean_chapter_paragraphed_text(
    book_code,
    chapter_number,
    true,
  );
