export function g_arc_review_marks() {
  "The words a review page is laid out with - what stands at the front of a conversation line, a catch_up, an opener, a turn's reference, its Scripture, its after and a tally line.";
