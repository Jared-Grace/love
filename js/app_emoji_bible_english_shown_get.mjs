...
export function app_emoji_bible_english_shown_get() {
  ...
  "It is a second, smaller offer beside the whole key. The key stacks the language the verse was written in, the English word for word and the Tagalog under every verse, which is four bands of text under a line of pictures; a reader who only wants to check what a verse says wants one of those bands and gets the page back for it.";
