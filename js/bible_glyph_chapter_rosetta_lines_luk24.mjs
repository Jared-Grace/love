export function bible_glyph_chapter_rosetta_lines_luk24() {
  ...
  let chapter = {
    ...
    verses: [
      ...
      {
        verse_number: 2,
        original: "εὗρον δὲ τὸν λίθον ἀποκεκυλισμένον ἀπὸ τοῦ μνημείου",
        english: "They found the stone rolled away from the tomb",
      },
      {
        verse_number: 3,
        original: "εἰσελθοῦσαι δὲ οὐχ εὗρον τὸ σῶμα τοῦ Κυρίου Ἰησοῦ",
        english:
      ...
      {
        verse_number: 8,
        original: "Καὶ ἐμνήσθησαν τῶν ῥημάτων αὐτοῦ",
        english: "Then they remembered His words",
      },
      {
        verse_number: 9,
        original:
      ...
      {
        verse_number: 16,
        original: "οἱ δὲ ὀφθαλμοὶ αὐτῶν ἐκρατοῦντο τοῦ μὴ ἐπιγνῶναι αὐτόν",
        english: "But their eyes were kept from recognizing Him",
      },
      {
        verse_number: 17,
        original:
      ...
      {
        verse_number: 34,
        original: "λέγοντας ὅτι Ὄντως ἠγέρθη ὁ Κύριος καὶ ὤφθη Σίμωνι",
        english:
      ...
      {
        verse_number: 37,
        original: "πτοηθέντες δὲ καὶ ἔμφοβοι γενόμενοι ἐδόκουν πνεῦμα θεωρεῖν",
        english:
      ...
      {
        verse_number: 40,
        original: "καὶ τοῦτο εἰπὼν ἔδειξεν αὐτοῖς τὰς χεῖρας καὶ τοὺς πόδας",
        english: "And when He had said this He showed them His hands and feet",
      },
      {
        verse_number: 41,
        original:
      ...
      {
        verse_number: 42,
        original: "οἱ δὲ ἐπέδωκαν αὐτῷ ἰχθύος ὀπτοῦ μέρος",
        english: "So they gave Him a piece of broiled fish",
      },
      {
        verse_number: 43,
        original: "καὶ λαβὼν ἐνώπιον αὐτῶν ἔφαγεν",
        english: "and He took it and ate it in front of them",
      },
      {
        verse_number: 44,
        original:
      ...
      {
        verse_number: 45,
        original: "τότε διήνοιξεν αὐτῶν τὸν νοῦν τοῦ συνιέναι τὰς γραφάς",
        english: "Then He opened their minds to understand the Scriptures",
      },
      {
        verse_number: 46,
        original:
      ...
      {
        verse_number: 53,
        original: "καὶ ἦσαν διὰ παντὸς ἐν τῷ ἱερῷ εὐλογοῦντες τὸν Θεόν",
        english: "praising God continually in the temple",
      },
    ],
  };
  return chapter;
