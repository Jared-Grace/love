export function g_day_matches() {
  ...
  "It was rejected once at this number, on the ground that it put plants of seventeen past the sixteen-person ceiling. That objection STANDS. It was set aside on the ground that a plant's room is chosen now - and the chosen-room model only exists in g_game_plants_whole, which nothing calls, and in the scheduler's own report. The generator that actually runs still fills a plant from the pool until the turns come out near the budget, so a bigger day buys more people, and at this number it buys seventeen and eighteen of them.";
