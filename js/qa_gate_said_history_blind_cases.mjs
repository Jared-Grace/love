export function qa_gate_said_history_blind_cases() {
  ...
  let cases = [
    {
      said: "git -C /dev/shm/qa_tree/abc/repos/love log --format=%H -- js/a.mjs exited with code 128\n\nSTDOUT:\n\n\nSTDERR:\nfatal: not a git repository (or any of the parent directories): .git\n",
      blind: true,
    ...
    {
      said: "the history names nobody for these functions, so git had nothing to say about who last touched them",
      blind: false,
