...
export async function app_ceb_bible_gloss_explains_unnamed_source_repair() {
  ...
  "A learner reading 'the analysis gives its root as' is being told about the tooling that wrote the explanation rather than about the word. The reworded sentence says exactly what the old one said and leaves the machinery out of it.";
