...
export function binisaya_words_roots_prompt(words, known) {
  ...
  "A word that opens its sentence is asked for under both spellings, because the dictionary is keyed by the spelling each word wore where it was gathered. Asking under one spelling only left the words a passage begins with looking like words the dictionary had never heard of - and the writing then went on to invent an origin for them, which is the one thing this whole text exists to stop.";
