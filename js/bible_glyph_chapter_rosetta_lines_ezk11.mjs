export function bible_glyph_chapter_rosetta_lines_ezk11() {
  ...
  let chapter = {
    ...
    verses: [
      ...
      {
        verse_number: 4,
        original: "לָכֵ֖ן הִנָּבֵ֣א עֲלֵיהֶ֑ם הִנָּבֵ֖א בֶּן־ אָדָֽם׃",
      ...
      },
      {
        ...
        english: "I told the exiles everything the LORD had shown me",
      },
    ],
  };
  return chapter;
