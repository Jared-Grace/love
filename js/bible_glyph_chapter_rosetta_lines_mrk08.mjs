export function bible_glyph_chapter_rosetta_lines_mrk08() {
  ...
  let chapter = {
    ...
    verses: [
      ...
      {
        verse_number: 5,
        original: "Καὶ ἠρώτα αὐτούς Πόσους ἔχετε ἄρτους Οἱ δὲ εἶπαν Ἑπτά",
        english: "How many loaves do you have Jesus asked Seven they replied",
      },
      {
        verse_number: 6,
        original:
      ...
      {
        verse_number: 9,
        original: "ἦσαν δὲ ὡς τετρακισχίλιοι καὶ ἀπέλυσεν αὐτούς",
        english:
      ...
      {
        verse_number: 13,
        original: "καὶ ἀφεὶς αὐτοὺς πάλιν ἐμβὰς ἀπῆλθεν εἰς τὸ πέραν",
        english:
      ...
      {
        verse_number: 16,
        original: "καὶ διελογίζοντο πρὸς ἀλλήλους ὅτι ἄρτους οὐκ ἔχουσιν",
        english:
      ...
      {
        verse_number: 21,
        original: "Καὶ ἔλεγεν αὐτοῖς Οὔπω συνίετε",
        english: "Then He asked them Do you still not understand",
      },
      {
        verse_number: 22,
        original:
      ...
      },
      {
        ...
        english: "Jesus sent him home and said Do not go back into the village",
      },
      {
        verse_number: 27,
        original:
      ...
      {
        verse_number: 30,
        original: "Καὶ ἐπετίμησεν αὐτοῖς ἵνα μηδενὶ λέγωσιν περὶ αὐτοῦ",
        english: "And Jesus warned them not to tell anyone about Him",
      },
      {
        verse_number: 31,
        original:
      ...
      {
        verse_number: 37,
        original: "τί γὰρ δοῖ ἄνθρωπος ἀντάλλαγμα τῆς ψυχῆς αὐτοῦ",
        english: "Or what can a man give in exchange for his soul",
      },
      {
        verse_number: 38,
        original:
