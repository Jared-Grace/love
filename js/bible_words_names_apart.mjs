...
export async function bible_words_names_apart(bible_folder) {
  ...
  "Measured on 2026-09-06 over the Cebuano bible, the test held out 72 words and 69 of them are plainly names, every one of which the dictionary had mis-rooted - Moises taken back to isi, Galilea to lili, Gideon to dili. The three it took wrongly are Gitak-opan, Pakiglantugi and Pantuna, ordinary words whose dictionary roots are sound, and they cost three sightings between them. Two of the three are commands, which is the shape most likely to defeat the test rather than bad luck: a command opens its sentence, so it can go through sixty-six books without once standing in the middle of one.";
