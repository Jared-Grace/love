...
export function app_code_lesson_expression_choose_order_pair_expression_parts({
  ...
  ("four given numbers and three given operators built into two comparisons compared against each other, with both pairs of parentheses written: (3 === 5) === (5 === 3)");
  ...
  ("Both pairs of parentheses are WRITTEN rather than left to be worked out. The two comparisons and the one between them are all the same strength, so a line printed without them would come out as 3 === 5 === (5 === 3) - true of how JS reads it, and the wrong thing to show a learner who is being asked which of two equals may go first. Written parentheses say the two sides are the same as each other, which is the whole shape of this lesson.");
  ...
  let left = app_code_expression_node_parenthesis_wrapped(
    first_number,
    left_symbol,
    second_number,
  );
