import { app_shared_bible_read_help_text } from "./app_shared_bible_read_help_text.mjs";
...
export async function app_shared_bible_read(context, verse_action) {
  ...
  let { unknown_shown, hash, count_status, content, bar, t, max, help_text } =
    app_shared_bible_read_help_text(r3);
  if (unknown_shown) {
    return;
  }
