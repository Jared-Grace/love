export function bible_glyph_chapter_rosetta_lines_jud01() {
  ...
  let chapter = {
    ...
    verses: [
      ...
      {
        verse_number: 2,
        original: "Ἔλεος ὑμῖν καὶ εἰρήνη καὶ ἀγάπη πληθυνθείη",
        english: "Mercy peace and love be multiplied to you",
      },
      {
        verse_number: 3,
        original:
      ...
      {
        verse_number: 19,
        original: "Οὗτοί εἰσιν οἱ ἀποδιορίζοντες ψυχικοί Πνεῦμα μὴ ἔχοντες",
        english:
      ...
      {
        verse_number: 22,
        original: "Καὶ οὓς μὲν ἐλεᾶτε διακρινομένους",
        english: "And indeed have mercy on those who doubt",
      },
      {
        verse_number: 23,
        original:
