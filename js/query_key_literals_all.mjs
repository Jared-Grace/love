...
export async function query_key_literals_all() {
  "Every place in this repo that writes a word straight into the query part of a page address. Read-only.";
  ...
  let sites = await key_literals_all_generic(candidates, js_query_key_literals);
  return sites;
}
