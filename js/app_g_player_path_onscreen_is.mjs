import { app_g_tiles_onscreen_window } from "./app_g_tiles_onscreen_window.mjs";
import { g_coordinates_window_inside_is } from "./g_coordinates_window_inside_is.mjs";
import { list_all } from "./list_all.mjs";
export function app_g_player_path_onscreen_is(path, div_map) {
  ...
  "it asks where the map is ACTUALLY scrolled to rather than where a centring scroll would put it, because the player may have dragged the map themselves - and what they can commit to is what is in front of them, whoever moved it there.";
  let window_tiles = app_g_tiles_onscreen_window(div_map);
