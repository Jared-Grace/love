export function bible_glyph_chapter_rosetta_lines_2ki03() {
  ...
  let chapter = {
    ...
    verses: [
      ...
      },
      {
        verse_number: 24,
        original:
          "וַיָּבֹאוּ֮ אֶל־ מַחֲנֵ֣ה יִשְׂרָאֵל֒ וַיָּקֻ֤מוּ יִשְׂרָאֵל֙ וַיַּכּ֣וּ אֶת־ מוֹאָ֔ב וַיָּנֻ֖סוּ מִפְּנֵיהֶ֑ם וַיָּבוֹ בָ֔הּ וְהַכּ֖וֹת אֶת־ מוֹאָֽב׃",
        english:
