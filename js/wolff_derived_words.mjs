...
export async function wolff_derived_words() {
  ...
  "One entry stands once under a spelling however many of its forms come to that spelling. The book distinguishes some forms by a mark this filing drops on purpose, so forms printed apart arrive here identical, and the entry standing twice would read as the book building the word twice.";
