...
export async function g_sermon_study(chapter_code) {
  ...
  function lambda(original_passage) {
    ...
    let study = g_sermon_study_passage(original_passage, edited_passage);
    return study;
  }
  let passages = list_map(originals, lambda);
  return {
    chapter_code,
    passages,
  };
