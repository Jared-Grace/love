...
export function g_time_components(time) {
  ...
  let bases = {
    morning: { r: 255, g: 178, b: 70, a: 0.6, saturate: 1.2, darkness: 0 },
    noon: { r: 175, g: 205, b: 255, a: 0.52, saturate: 0.8, darkness: 0 },
    ...
    sunrise: { r: 255, g: 140, b: 178, a: 0.62, saturate: 0.55, darkness: 0.48 },
  };
