...
export async function g_sermon_write_publish(chapter_code, verse_numbers, scripture, lines) {
  await g_sermon_write(chapter_code, verse_numbers, scripture, lines);
