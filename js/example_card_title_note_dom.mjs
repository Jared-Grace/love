...
("The heading + note that open every card. The note may embed inline-code segments (alias / fn name), so it renders through ",
  example_note_dom.name,
  ".");
export function example_card_title_note_dom(card, title, note, alias) {
  ...
  html_style_font_size(heading, "1.15rem");
  html_style_margin(heading, "0 0 0.35rem");
