...
export function html_loading_spinner(parent) {
  "the runtime loading spinner as live dom: inject the shared keyframes, then render the shared spinner markup into a fresh div. single-sourced with the static splash (both read html_loading_spinner_markup + html_loading_spinner_keyframes_css) so the two can never drift";
