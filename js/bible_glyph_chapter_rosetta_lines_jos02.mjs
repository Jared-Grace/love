export function bible_glyph_chapter_rosetta_lines_jos02() {
  ...
  let chapter = {
    ...
    verses: [
      ...
      },
      {
        verse_number: 13,
        original:
          "וְהַחֲיִתֶ֞ם אֶת־ אָבִ֣י וְאֶת־ אִמִּ֗י וְאֶת־ אַחַי֙ וְאֶת־ אַחוֹתַי וְאֵ֖ת כָּל־ אֲשֶׁ֣ר לָהֶ֑ם וְהִצַּלְתֶּ֥ם אֶת־ נַפְשֹׁתֵ֖ינוּ מִמָּֽוֶת׃",
        english:
