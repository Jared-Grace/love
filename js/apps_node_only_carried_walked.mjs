...
export async function apps_node_only_carried_walked() {
  ...
  "It asserts it looked at something before reporting what it found, which is the same worry the count answers one step further on - here it stops the run rather than reporting a number, because a walk that reached no function at all is not a reading anybody should be handed. Why the count travels with the names at all is written down next door, where it is made.";
  ...
  let r = names_walked(f_names, carried);
  return r;
}
