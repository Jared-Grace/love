export function app_en_learn_bible_gloss_urdu_noun_explains() {
  ...
  let r = {
    ...
    nation: "اِسم ہے: قَوم، یعنی ایک ہی مُلک یا ایک ہی نسل کے سب لوگ۔",
    ...
    promise: "اِسم ہے: وعدہ، یعنی وہ بات جو کہی گیٔی ہے کہ پُوری کی جائے گی۔",
    ...
    sin: "اِسم ہے: گُناہ۔",
    judgment:
      "اِسم ہے: فَیصلہ، یعنی وہ بات جو صحیح اَور غلط دیکھ کر کہی جائے۔ انگریزی میں یہ 'judge' سے بنا ہے، یعنی فَیصلہ کرنے والے سے۔",
    ...
    kingdom:
      "اِسم ہے: بادشاہی، یعنی وہ سب جِس پر کویٔی بادشاہ حُکومت کرتا ہے۔ یہ لفظ 'king' یعنی بادشاہ سے بنا ہے: آخِر میں '-dom' لگانے سے اُس کی حُکومت کا نام بن جاتا ہے۔",
  };
  return r;
}
