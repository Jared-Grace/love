...
export async function qa_gate_run_start_wanted_is() {
  ...
  "All this does is go and look. What the numbers mean is decided next door, where the question can be put to written-down numbers and answered the same way twice";
