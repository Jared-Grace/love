...
export function app_shared_bible_mode_set(mode) {
  "share one storage key with the getter by using its function name as the namespace";
  storage_local_set(app_shared_bible_mode_get, "mode", mode);
  ...
  html_hash_property_set(app_shared_bible_mode_hash_key(), mode);
}
