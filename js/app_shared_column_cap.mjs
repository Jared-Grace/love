import { app_shared_column_cap_width } from "./app_shared_column_cap_width.mjs";
import { html_style_set } from "./html_style_set.mjs";
import { html_style_margin_x } from "./html_style_margin_x.mjs";
export function app_shared_column_cap(element) {
  ...
  let width = app_shared_column_cap_width();
