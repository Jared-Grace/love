...
export function html_code_recorder_include() {
  ...
  let attributes_none = {};
  let code =
    "if (location.pathname.indexOf('/dev/') !== -1 && location.search.indexOf('record') !== -1) { var page_recorder = document.createElement('script'); page_recorder.src = 'recorder.js'; document.head.appendChild(page_recorder); }";
