...
export function storage_key_seams_durable() {
  ...
  let seams = [
    fn_name("storage_local_set"),
    fn_name("storage_local_remove"),
    fn_name("storage_local_exists"),
    fn_name("storage_local_quarantine"),
    fn_name("storage_local_name_get"),
    fn_name("html_error_records_storage_key"),
    fn_name("app_shared_contact_user_id_storage_key"),
    fn_name("html_code_error_send_script"),
  ];
  return seams;
}
