...
export function app_shared_contact_button(parent, app_fn) {
  ...
  "returns the button so each app can stylize its own instance (e.g. width) without this shared component imposing an app-specific layout on every other app";
