...
export async function baseline_names_gate_advice_generic(
  ...
  ("THE COMPARISON ITSELF IS MADE ONE NAME ALONG, shared with the writer that shrinks the record. This tooth of the ratchet and that one have to mean the same thing by a new offender and by a gone one, and they did so by each spelling it out.");
