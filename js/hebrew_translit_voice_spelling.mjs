...
export function hebrew_translit_voice_spelling(translit) {
  ...
  "★ THE AND-HE-DID OPENING IS SAID IN THREE SOUNDS, NOT TWO. The story tells itself with it - and he said, and he went, and there was - and where no doubled letter follows, the yod in it carries a mark the voice sounds: va-ye-hi, not vay-hi. A listener counted the sounds. Where a doubled yod does follow, the writing already agrees with the voice and is left alone: 1,608 of the 1,909 are that kind, and the 301 that are not are the ones mended here.";
  ...
  let told = translit.replace(/way·(?!y)/g, "wa·yə·");
  let tied = told.replaceAll("ā·yə·", "āy·");
