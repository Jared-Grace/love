...
export function app_music_song_line_show(
  folds,
  parent,
  words,
  references,
  ...
  "IT CARRIES THE SONG'S TRANSLATION CHOICES THROUGH WITHOUT READING THEM. A line does not decide which bible its passages come out of; the song does, and each passage under this line has to be told. Handing the list down is what keeps the decision one song's own rather than the whole page's, and this is simply the road it travels.";
  ...
  for (let reference of references) {
    let asked = app_music_reference_show(body, reference, versions);
