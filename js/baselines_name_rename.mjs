...
export async function baselines_name_rename(name_before, name_after) {
  ...
  ("The list is sorted after the substitution, because a name that changed almost never sorts where the old one did, and every one of these records is kept in order.");
