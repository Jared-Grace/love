...
export function literals_frozen_names() {
  ...
  let names = [
    fn_name("app_a_app_selected_key"),
    fn_name("app_a_function_name_selected_key"),
    fn_name("browser_files_path_key"),
    fn_name("app_search_query_hash_key"),
    fn_name("app_shared_bible_mode_hash_key"),
    fn_name("browser_files_store"),
    fn_name("browser_files_database_name"),
    fn_name("download_cache_database_name"),
    fn_name("download_cache_store"),
    fn_name("g_conversation_key"),
    fn_name("ebible_offline_database_name"),
    fn_name("ebible_offline_store"),
    fn_name("app_shared_bible_chapter_hash_key"),
    fn_name("app_shared_bible_verse_hash_key"),
    fn_name("app_shared_bible_language_hash_key"),
    fn_name("app_supper_passage_hash_key"),
    fn_name("app_supper_folders_hash_key"),
    fn_name("app_shared_bible_book_hash_key"),
    fn_name("app_shared_bible_reference_hash_key"),
    fn_name("app_code_lesson_hash_key"),
    fn_name("app_shared_screen_hash_key"),
    fn_name("app_code_quiz_hash_key"),
    fn_name("g_verify_chapter_query_key"),
    fn_name("g_verify_chapter_storage_key"),
    fn_name("verse_number_key"),
    fn_name("language_code_key"),
    fn_name("bible_folder_key"),
    fn_name("git_message_hand_made"),
    fn_name("g_sermon_generate_upload_namespace"),
    fn_name("g_sermon_write_upload_namespace"),
    fn_name("g_objection_generate_upload_namespace"),
    fn_name("g_arc_generate_upload_namespace"),
    fn_name("gloss_upload_namespace_ceb_bible"),
    fn_name("gloss_upload_namespace_original_bible"),
    fn_name("g_verify_status_namespace"),
    fn_name("g_verify_approval_namespace"),
    fn_name("firebase_prod_app_backup_namespace"),
    fn_name("app_replace_animation_duration_hash_key"),
    ...
    fn_name("app_en_learn_bible_gloss_urdu_words_sound_upload_namespace"),
    fn_name("app_code_review_hash_key"),
