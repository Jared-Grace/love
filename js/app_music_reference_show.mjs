...
export function app_music_reference_show(parent, reference, versions) {
  "$plain reference";
  ...
  "THE SONG'S OWN TRANSLATION CHOICES ARE HANDED IN, because the same passage may be quoted one way in this song and another way in the song next door. Reaching for one list belonging to the page would put the other song's wording under this song's line, and the caption would name it correctly, so nothing on the screen would look wrong.";
