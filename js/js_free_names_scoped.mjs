import { js_identifiers_referenced_nodes_one_walk } from "./js_identifiers_referenced_nodes_one_walk.mjs";
...
export function js_free_names_scoped(ast) {
  ...
  let referenced_nodes = js_identifiers_referenced_nodes_one_walk(ast);
