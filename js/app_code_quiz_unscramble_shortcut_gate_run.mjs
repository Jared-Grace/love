...
export function app_code_quiz_unscramble_shortcut_gate_run() {
  ...
  let hint =
    "these lessons accept an answer that leaves out a token the question wrote, or parentheses something the question did not parenthesis - a learner passes without doing the thing the lesson is about. widen nothing to fix it: look at what put the easier ordering in the pool";
