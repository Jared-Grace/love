...
export async function html_copy_fly_rect(component, rect_to, duration) {
  ...
  ("The copy arrives looking exactly as it set out. What it is for is that one thing was seen going from here to there, and a copy that changes on the way is a second thing to follow at the very moment the eye is busy following the first.");
