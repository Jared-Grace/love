...
export async function functions_builtin_calls_repair() {
  "Says the covered built-in calls with the repo's own names, in exactly the files still spelling one.";
  ...
  let left = await functions_builtin_calls_pending();
