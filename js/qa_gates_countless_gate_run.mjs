...
export async function qa_gates_countless_gate_run() {
  ...
  "Measured against the baseline rather than against zero, because ninety-five gates already answered this way on the day it was written and rewriting all ninety-five at once is a worse trade than stopping the ninety-sixth. What it holds is the thing worth holding: the gate written today may not be the ninety-sixth.";
