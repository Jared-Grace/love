export function youtube_signed_in_script() {
  ...
  let lines = [
    ...
    "};",
    "window.playlist_name_set = async function (playlist_id, name) {",
    "  return await window.playlist_edit(playlist_id, [{ action: 'ACTION_SET_PLAYLIST_NAME', playlistName: name }]);",
    "};",
