export function bible_glyph_chapter_rosetta_lines_deu18() {
  ...
  let chapter = {
    ...
    verses: [
      ...
      {
        verse_number: 13,
        original: "תָּמִ֣ים תִּֽהְיֶ֔ה עִ֖ם יְהוָ֥ה אֱלֹהֶֽיךָ׃ס",
        english: "You must be blameless before the LORD your God",
      },
      {
        verse_number: 14,
        original:
      ...
      {
        verse_number: 17,
        original: "וַיֹּ֥אמֶר יְהוָ֖ה אֵלָ֑י הֵיטִ֖יבוּ אֲשֶׁ֥ר דִּבֵּֽרוּ׃",
        english: "Then the LORD said to me They have spoken well",
      },
      {
        verse_number: 18,
        original:
