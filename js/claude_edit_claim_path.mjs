...
export function claude_edit_claim_path(file_path) {
  `node's path.resolve, not the repo's ${fn_name("path_resolve")}, because that wrapper is`;
  `async — awaiting it would force this and ${fn_name("claude_edit_claim_fresh_is")} to be`;
