...
export async function gloss_explains_repeated_baseline_growth_assert(counts) {
  "Refuse to record a gloss store handing one word's explanation to a larger share of its other words than the record already held.";
  ...
  await baseline_growth_assert_generic(
    counts,
    path,
    gloss_store_shares_versus_baseline,
    "these gloss stores hand one word's explanation to a larger share of their other words than the record holds - write the second word its own explanation rather than recording the larger share as known",
  );
}
