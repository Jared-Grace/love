...
export function app_code_lesson_functions_console_log_greater_than_equal() {
  ...
  let explanation = [
    ["if ", greater_symbol, " is ", js_keyword_true(), ", then ", symbol, " is ", js_keyword_true()],
    ["if ", equal_symbol, " is ", js_keyword_true(), ", then ", symbol, " is ", js_keyword_true()],
    ["if ", less_symbol, " is ", js_keyword_true(), ", then ", symbol, " is ", js_keyword_false()],
  ];
  function closing(fn_name) {
    let parts = ["", symbol, " is like ", greater_symbol, " ", or_symbol, " ", equal_symbol];
    return parts;
  }
