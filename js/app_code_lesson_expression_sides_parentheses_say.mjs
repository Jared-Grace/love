...
export function app_code_lesson_expression_sides_parentheses_say(run, sides) {
  ...
  ("why the two sides of a line go first, told for a line whose two sides stand in parentheses: the parentheses are pointed at, the question is asked, and a part always coming to the same value is what answers it");
