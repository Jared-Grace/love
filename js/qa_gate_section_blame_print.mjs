...
export async function qa_gate_section_blame_print(section, known) {
  ...
  ("Prints who last touched each thing one gate named, under a heading saying which gate named them, and gives back the ones somebody is still working on.");
  ...
  ("Only the names somebody is still working on come back, in the two degrees they are told apart in - being edited now, and committed within the hour. They are wanted all together at the end rather than gate by gate, because one peer's topic is usually why several gates went red at once and saying so once is the whole of the news.");
