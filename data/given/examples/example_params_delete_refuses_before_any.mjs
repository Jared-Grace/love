...
export const example = {
  ...
  note: [
    ...
    " is real and ",
    { code: "facto" },
    " is a letter short. Applying them one at a time dropped ",
    { code: "factor" },
    " from the declaration and from every call site, and only then gave up — a folder left half changed under a command that reported a refusal. Every name is checked before any is removed, so the second one being wrong means the first one never moves.",
  ],
